...
public class Base64Coder
{
    ...
    public static char[] encode(final byte[] in, final int iOff, final int iLen) {
        ...
        int o2;
        int o3;
        for (int ip = iOff, iEnd = iOff + iLen, op = 0; ip < iEnd; i0 = (in[ip++] & 0xFF), i = ((ip < iEnd) ? (in[ip++] & 0xFF) : 0), i2 = ((ip < iEnd) ? (in[ip++] & 0xFF) : 0), o0 = i0 >>> 2, o = ((i0 & 0x3) << 4 | i >>> 4), o2 = ((i & 0xF) << 2 | i2 >>> 6), o3 = (i2 & 0x3F), out[op++] = Base64Coder.map1[o0], out[op++] = Base64Coder.map1[o], out[op] = ((op < oDataLen) ? Base64Coder.map1[o2] : '='), ++op, out[op] = ((op < oDataLen) ? Base64Coder.map1[o3] : '='), ++op) {}
        return out;
    }
