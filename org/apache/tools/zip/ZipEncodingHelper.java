...
public abstract class ZipEncodingHelper
{
    ...
    static void appendSurrogate(final ByteBuffer bb, final char c) {
        bb.put((byte)37);
        bb.put((byte)85);
        bb.put(ZipEncodingHelper.HEX_DIGITS[c >> 12 & '\u000f']);
        bb.put(ZipEncodingHelper.HEX_DIGITS[c >> 8 & '\u000f']);
        bb.put(ZipEncodingHelper.HEX_DIGITS[c >> 4 & '\u000f']);
    ...
    static {
        ...
        final SimpleEncodingHolder cp2 = new SimpleEncodingHolder(cp850_high_chars);
        se.put("CP850", cp2);
        se.put("Cp850", cp2);
        se.put("cp850", cp2);
        se.put("IBM850", cp2);
