...
public class IsBackstabbed extends CheckInSightPartCriterion
{
    public IsBackstabbed(final ArrayList<ParserObject> args) {
        super();
    ...
    protected boolean isInSightPartConcerned(final Part part) {
        return part != null && part.getPartId() == 2;
    }
    
    @Override
    public Enum getEnum() {
        return WakfuCriterionIds.IS_BACKSTABBED;
    }
}
