...
public class IsAchievementRunning extends FunctionCriterion
{
    ...
    protected List<ParserType[]> getSignatures() {
        return IsAchievementRunning.signatures;
    }
    
    public IsAchievementRunning() {
        super();
    }
    
    public IsAchievementRunning(final ArrayList<ParserObject> args) {
        super();
    ...
    public int getValidity(final Object criterionUser, final Object criterionTarget, final Object criterionContent, final Object criterionContext) {
        ...
        if (achievementContext.hasAchievement(this.m_achievementId)) {
            return achievementContext.isAchievementRunning(this.m_achievementId) ? 0 : -1;
        }
        return -1;
    }
    ...
    @Override
    public Enum getEnum() {
        return WakfuCriterionIds.IS_ACHIEVEMENT_RUNNING;
    }
    
    static {
        IsAchievementRunning.signatures = new ArrayList<ParserType[]>();
        final ParserType[] sig = { ParserType.NUMBER };
        IsAchievementRunning.signatures.add(sig);
    }
}
