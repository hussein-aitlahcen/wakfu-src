...
public final class IsCarryingOwnBarrel extends FunctionCriterion
{
    ...
    protected List<ParserType[]> getSignatures() {
        return IsCarryingOwnBarrel.SIGNATURES;
    }
    
    public IsCarryingOwnBarrel(final ArrayList<ParserObject> args) {
        super();
    ...
    public int getValidity(final Object criterionUser, final Object criterionTarget, final Object criterionContent, final Object criterionContext) {
        ...
        if (!(carryTarget instanceof AbstractBarrelEffectArea)) {
            return -1;
        }
    ...
    @Override
    public Enum getEnum() {
        return WakfuCriterionIds.IS_CARRYING_OWN_BARREL;
    }
    
    static {
        (SIGNATURES = new ArrayList<ParserType[]>()).add(CriterionConstants.EMPTY_SIGNATURE);
        IsCarryingOwnBarrel.SIGNATURES.add(CriterionConstants.ONE_STRING_SIGNATURE);
    }
}
