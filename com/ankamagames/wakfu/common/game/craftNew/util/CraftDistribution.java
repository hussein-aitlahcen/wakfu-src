...
public class CraftDistribution extends Distribution
{
    ...
    public CraftDistribution(final short playerLevel, final CraftRecipeReference recipe) {
        super(getMean(playerLevel, recipe), recipe.getNbResultItems() / 8.0);
    }
    
    public static double getMean(final short playerLevel, final CraftRecipeReference recipe) {
