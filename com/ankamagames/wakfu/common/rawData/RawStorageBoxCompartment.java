...
public class RawStorageBoxCompartment implements VersionableObject
{
    public int id;
    public final ArrayList<Item> items;
    
    public RawStorageBoxCompartment() {
        super();
        this.id = 0;
    ...
    public boolean unserializeVersion(final ByteBuffer buffer, final int version) {
        ...
        final RawStorageBoxCompartmentConverter converter = new RawStorageBoxCompartmentConverter();
    ...
    public static class Item implements VersionableObject
    {
        ...
        private final class ItemConverter
        {
            ...
            private boolean unserialize_v0(final ByteBuffer buffer) {
                this.position = buffer.getShort();
                final boolean item_ok = this.item.unserializeVersion(buffer, 0);
                return item_ok;
            }
    ...
    private final class RawStorageBoxCompartmentConverter
    {
        private int id;
        private final ArrayList<Item> items;
        
        private RawStorageBoxCompartmentConverter() {
            super();
            this.id = 0;
            this.items = new ArrayList<Item>(0);
        }
        ...
        public void pushResult() {
            RawStorageBoxCompartment.this.id = this.id;
            RawStorageBoxCompartment.this.items.clear();
            RawStorageBoxCompartment.this.items.ensureCapacity(this.items.size());
            RawStorageBoxCompartment.this.items.addAll(this.items);
        }
