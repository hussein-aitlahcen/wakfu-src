...
public class RawGuildStorageCompartment implements VersionableObject
{
    public int id;
    ...
    public RawGuildStorageCompartment() {
        super();
        this.id = -1;
        this.enabled = true;
    ...
    public boolean unserialize(final ByteBuffer buffer) {
        ...
        final boolean building_present = buffer.get() == 1;
        if (building_present) {
    ...
    public boolean unserializeVersion(final ByteBuffer buffer, final int version) {
        ...
        final RawGuildStorageCompartmentConverter converter = new RawGuildStorageCompartmentConverter();
    ...
    public final void internalToString(final StringBuilder repr, final String prefix) {
        ...
        repr.append(prefix).append("enabled=").append(this.enabled).append('\n');
    ...
    public static class Building implements VersionableObject
    {
        ...
        @Override
        public boolean serialize(final ByteBuffer buffer) {
            buffer.putLong(this.buildingUid);
            return true;
        }
        
        @Override
        public boolean unserialize(final ByteBuffer buffer) {
            this.buildingUid = buffer.getLong();
            return true;
        }
        ...
        public final void internalToString(final StringBuilder repr, final String prefix) {
            repr.append(prefix).append("buildingUid=").append(this.buildingUid).append('\n');
        }
    }
    
    private final class RawGuildStorageCompartmentConverter
    {
        private int id;
        ...
        private RawGuildStorageCompartmentConverter() {
            super();
            this.id = -1;
            this.enabled = true;
            this.items = new ArrayList<Item>(0);
        ...
        public void pushResult() {
            RawGuildStorageCompartment.this.id = this.id;
            RawGuildStorageCompartment.this.enabled = this.enabled;
            RawGuildStorageCompartment.this.items.clear();
            RawGuildStorageCompartment.this.items.ensureCapacity(this.items.size());
            RawGuildStorageCompartment.this.items.addAll(this.items);
            RawGuildStorageCompartment.this.building = this.building;
        }
        ...
        private boolean unserialize_v10025000(final ByteBuffer buffer) {
            this.id = buffer.getInt();
            this.enabled = (buffer.get() == 1);
            final int items_size = buffer.getShort() & 0xFFFF;
            this.items.clear();
            ...
            for (int i = 0; i < items_size; ++i) {
                final Item items_element = new Item();
                final boolean items_element_ok = items_element.unserializeVersion(buffer, 10025000);
                if (!items_element_ok) {
                    return false;
                }
                this.items.add(items_element);
        ...
        private boolean unserialize_v10025001(final ByteBuffer buffer) {
            this.id = buffer.getInt();
            this.enabled = (buffer.get() == 1);
            final int items_size = buffer.getShort() & 0xFFFF;
            this.items.clear();
            ...
            for (int i = 0; i < items_size; ++i) {
                final Item items_element = new Item();
                final boolean items_element_ok = items_element.unserializeVersion(buffer, 10025001);
                if (!items_element_ok) {
                    return false;
                }
                this.items.add(items_element);
            ...
            if (building_present) {
                this.building = new Building();
                final boolean building_ok = this.building.unserializeVersion(buffer, 10025001);
                if (!building_ok) {
                    return false;
                }
            }
        ...
        private boolean unserialize_v10028000(final ByteBuffer buffer) {
            ...
            if (building_present) {
                this.building = new Building();
                final boolean building_ok = this.building.unserializeVersion(buffer, 10028000);
                if (!building_ok) {
                    return false;
                }
            }
        ...
        private boolean unserialize_v10029000(final ByteBuffer buffer) {
            ...
            if (building_present) {
                this.building = new Building();
                final boolean building_ok = this.building.unserializeVersion(buffer, 10029000);
                if (!building_ok) {
                    return false;
                }
            }
        ...
        private boolean unserialize_v10032003(final ByteBuffer buffer) {
            ...
            if (building_present) {
                this.building = new Building();
                final boolean building_ok = this.building.unserializeVersion(buffer, 10032003);
                if (!building_ok) {
                    return false;
                }
            }
        ...
        private boolean unserialize_v10035004(final ByteBuffer buffer) {
            ...
            if (building_present) {
                this.building = new Building();
                final boolean building_ok = this.building.unserializeVersion(buffer, 10035004);
                if (!building_ok) {
                    return false;
                }
            }
        ...
        private boolean unserialize_v10035007(final ByteBuffer buffer) {
            ...
            if (building_present) {
                this.building = new Building();
                final boolean building_ok = this.building.unserializeVersion(buffer, 10035007);
                if (!building_ok) {
                    return false;
                }
            }
        ...
        private boolean unserialize_v10036004(final ByteBuffer buffer) {
            ...
            if (building_present) {
                this.building = new Building();
                final boolean building_ok = this.building.unserializeVersion(buffer, 10036004);
                if (!building_ok) {
                    return false;
                }
            }
        ...
        public void convert_v10023_to_v10025000() {
        }
        
        public void convert_v10025000_to_v10025001() {
        }
        
        public void convert_v10025001_to_v10028000() {
        }
        ...
        public boolean unserializeVersion(final ByteBuffer buffer, final int version) {
            ...
            if (version < 1) {
                ...
                if (ok) {
                    ...
                    this.convert_v315_to_v10003();
                    this.convert_v10003_to_v10023();
                    this.convert_v10023_to_v10025000();
                    this.convert_v10025000_to_v10025001();
                    this.convert_v10025001_to_v10028000();
                    this.convert_v10028000_to_v10029000();
                    this.convert_v10029000_to_v10032003();
                    this.convert_v10032003_to_v10035004();
                    this.convert_v10035004_to_v10035007();
            ...
            else if (version < 10025001) {
                final boolean ok = this.unserialize_v10025000(buffer);
                if (ok) {
                    this.convert_v10025000_to_v10025001();
                    this.convert_v10025001_to_v10028000();
                    this.convert_v10028000_to_v10029000();
                ...
                final boolean ok = this.unserialize_v10025001(buffer);
                if (ok) {
                    this.convert_v10025001_to_v10028000();
                    this.convert_v10028000_to_v10029000();
                    this.convert_v10029000_to_v10032003();
