...
public final class ClientEventCompanionEnterFight implements ClientGameEvent
{
    public static final ParameterListSet PARAMETERS_LIST_SET;
    
    @Override
    public int getId() {
        return ClientGameEventProtocol.COMPANION_ENTER_FIGHT.getId();
    }
    
    @Override
    public String[] getProperties() {
        return ClientEventCompanionEnterFight.NO_PROPERTIES;
    }
    
    @Override
    public ParameterListSet getParametersListSet() {
        return ClientEventCompanionEnterFight.PARAMETERS_LIST_SET;
    }
