...
public class AptitudeRestatItemAction extends AbstractClientItemAction
{
    public AptitudeRestatItemAction(final int id) {
        super(id);
    }
    ...
    public ItemActionConstants getType() {
        return ItemActionConstants.APTITUDE_RESTAT;
    }
}
