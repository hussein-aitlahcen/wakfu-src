...
public final class LootChestItemizableInfo extends BasicItemizableInfo<LootChest>
{
    public LootChestItemizableInfo(final LootChest linkedElement) {
        super(linkedElement);
    }
