...
public class GloomyEffect extends Effect
{
    ...
    public void update(final int timeIncrement) {
        ...
        final int level = MathHelper.clamp((int)this.getStrength() * 100, 0, 100);
    ...
    private void createSystem(final int level) {
        final FreeParticleSystem system = IsoParticleSystemFactory.getInstance().getFreeParticleSystem(7000074, level);
