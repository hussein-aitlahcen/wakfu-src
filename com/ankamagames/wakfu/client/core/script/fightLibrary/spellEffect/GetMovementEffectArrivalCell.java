...
final class GetMovementEffectArrivalCell extends SpellEffectActionFunction
{
    ...
    GetMovementEffectArrivalCell(final LuaState luaState, final SpellEffectActionInterface spellEffectAction) {
    ...
    public LuaScriptParameterDescriptor[] getResultDescriptors() {
        return GetMovementEffectArrivalCell.RESULTS;
    }
    ...
    protected void run(final int paramCount) throws LuaException {
        ...
        final Point3 position = ((MovementEffect)effect).getArrivalCell();
