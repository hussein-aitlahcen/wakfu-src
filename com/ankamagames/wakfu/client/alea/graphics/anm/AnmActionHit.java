...
public class AnmActionHit extends AnmAction
{
    public static final AnmActionHit INSTANCE;
    ...
    public final AnmActionTypes getType() {
        return AnmActionTypes.HIT;
    }
    
    @Override
    public final boolean equals(final Object o) {
        return o == AnmActionHit.INSTANCE;
    }
