...
public class AnmActionEnd extends AnmAction
{
    public static final AnmActionEnd INSTANCE;
    ...
    public final AnmActionTypes getType() {
        return AnmActionTypes.END;
    }
    
    @Override
    public final boolean equals(final Object o) {
        return o == AnmActionEnd.INSTANCE;
    }
