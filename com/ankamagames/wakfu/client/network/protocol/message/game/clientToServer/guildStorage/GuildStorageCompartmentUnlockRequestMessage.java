...
public class GuildStorageCompartmentUnlockRequestMessage extends OutputOnlyProxyMessage
{
    ...
    static {
        m_logger = Logger.getLogger((Class)GuildStorageCompartmentUnlockRequestMessage.class);
    }
}
