...
public class AchievementTryToActivateRequestMessage extends OutputOnlyProxyMessage
{
    private final int m_achievementId;
    
    public AchievementTryToActivateRequestMessage(final int achievementId) {
        super();
