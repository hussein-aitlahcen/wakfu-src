...
public class CollectorInventoryFreeModificationRequestMessage extends OutputOnlyProxyMessage
{
    private final InventoryAction m_action;
    
    public CollectorInventoryFreeModificationRequestMessage(final InventoryAction action) {
        super();
