...
public class UnlockStorageBoxCompartmentRequestMessage extends OutputOnlyProxyMessage
{
    ...
    static {
        m_logger = Logger.getLogger((Class)UnlockStorageBoxCompartmentRequestMessage.class);
    }
}
