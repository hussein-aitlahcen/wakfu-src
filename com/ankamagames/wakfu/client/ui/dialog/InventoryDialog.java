...
public class InventoryDialog implements BasicElementFactory
{
    ...
    public BasicElement getElement(final Environment env, final ElementMap item) {
        ...
        element.setPrefSize(new Dimension(0, 80));
        ...
        checkOut5.setInsets(new Insets(3, 4, 0, 4));
        ...
        checkOut6.setPrefSize(new Dimension(220, 0));
        ...
        checkOut8.setInsets(new Insets(0, 5, 0, 6));
        ...
        checkOut9.setName("editableBag");
        checkOut9.setLocal(true);
        checkOut9.setField("bagInventory");
        ...
        checkOut10.setName("equipment.inventory.enableMove");
        checkOut10.setAttribute("enableDND");
        ...
        onItemDoubleClick.setCallBackFunc("wakfu.equipment:onItemDoubleClick(bag)");
        element8.setOnItemDoubleClick(onItemDoubleClick);
        final ItemClickListener onItemClick = new ItemClickListener();
        onItemClick.setCallBackFunc("wakfu.equipment:openItemDetailWindow(inventWindow)");
        ...
        element8.setOnDropOut(onDropOut);
        ...
        onMouseExit.setCallBackFunc("wakfu.equipment:changeItemBackground(inventWindow,currentItem)");
        checkOut12.setOnMouseExit(onMouseExit);
        final MouseEnteredListener onMouseEnter = new MouseEnteredListener();
        onMouseEnter.setCallBackFunc("wakfu.equipment:changeItemBackground(inventWindow,currentItem)");
        ...
        onDrop.setCallBackFunc("wakfu.equipment:inventoryDropItem(bag)");
        element21.setOnDrop(onDrop);
        final DragListener onDrag = new DragListener();
        onDrag.setCallBackFunc("wakfu.equipment:inventoryDragItem(bag)");
        ...
        element40.setKey("tableIndex");
        element39.addBasicElement(element40);
        element40.onAttributesInitialized();
        final LessCondition element41 = new LessCondition();
        ...
        checkOut16.setName("editableBag");
        checkOut16.setLocal(true);
        checkOut16.setField("bagSize");
        ...
        final StaticLayout element42 = new StaticLayout();
        ...
        element43.setSize(new Dimension(43, 43));
        checkOut18.addBasicElement(element43);
        element43.onAttributesInitialized();
        element43.onChildrenAdded();
        final DragNDropContainer element44 = new DragNDropContainer();
        element44.onCheckOut();
        element44.setElementMap(elementMap);
        final DropListener onDrop2 = new DropListener();
        onDrop2.setCallBackFunc("wakfu.equipment:inventoryDropItem(bag)");
        element44.setOnDrop(onDrop2);
        final DragListener onDrag2 = new DragListener();
        onDrag2.setCallBackFunc("wakfu.equipment:InventoryDragItem(bag)");
        element44.setOnDrag(onDrag2);
        checkOut18.addBasicElement(element44);
