...
public class SplitExchangeDialog implements BasicElementFactory
{
    private Stack<ElementMap> elementMaps;
    private Environment env;
    
    public SplitExchangeDialog() {
        super();
    ...
    public BasicElement getElement(final Environment env, final ElementMap item) {
        ...
        onMousePress.setCallBackFunc("wakfu.exchange:decreaseSplitCount");
        ...
        onMousePress2.setCallBackFunc("wakfu.exchange:increaseSplitCount");
