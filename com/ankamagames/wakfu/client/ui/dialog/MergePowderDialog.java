...
public class MergePowderDialog implements BasicElementFactory
{
    private Stack<ElementMap> elementMaps;
    private Environment env;
    
    public MergePowderDialog() {
        super();
    ...
    public BasicElement getElement(final Environment env, final ElementMap item) {
        ...
        element9.setText("%mergePowder%".replace("%mergePowder%", Xulor.getInstance().getTranslatedString("mergePowder")));
        ...
        element11.setText("%mergePowder.items%".replace("%mergePowder.items%", Xulor.getInstance().getTranslatedString("mergePowder.items")));
        ...
        onItemClick.setCallBackFunc("wakfu.mergeGem:openItemDetailWindow(mergeGemWindow);wakfu.mergeGem:addIngredient(true)");
        ...
        this.method60(element);
        this.method61(element);
        this.method62(element);
    ...
    public BasicElement method54(final BasicElement basicElement) {
        ...
        checkOut16.setStyle("itemBackground");
        ...
        element33.setExpandable(false);
        element33.setText("%mergePowder.insertPowder%".replace("%mergePowder.insertPowder%", Xulor.getInstance().getTranslatedString("mergePowder.insertPowder")));
        ...
        checkOut19.setElementMap(elementMap);
        checkOut19.setInsets(new Insets(3, 3, 3, 3));
        ...
        checkOut20.setElementMap(elementMap);
        element36.addBasicElement(checkOut20);
        checkOut20.onAttributesInitialized();
        checkOut20.onChildrenAdded();
        element36.onChildrenAdded();
        element34.onChildrenAdded();
    ...
    public BasicElement method57(final BasicElement basicElement) {
        ...
        checkOut.setElementMap(elementMap);
        final PopupDisplayListener onPopupDisplay = new PopupDisplayListener();
        onPopupDisplay.setCallBackFunc("popup(quantityDesc)");
        checkOut.setOnPopupDisplay(onPopupDisplay);
        final PopupHideListener onPopupHide = new PopupHideListener();
        onPopupHide.setCallBackFunc("closePopup");
        checkOut.setOnPopupHide(onPopupHide);
        ...
        element.setText("%requiredQuantity%".replace("%requiredQuantity%", Xulor.getInstance().getTranslatedString("requiredQuantity")));
        ...
        element3.onCheckOut();
        element3.setElementMap(elementMap);
        element3.setStyle("collectMachineLeftArrow");
        checkOut.addBasicElement(element3);
        element3.onAttributesInitialized();
        final StaticLayoutData element4 = new StaticLayoutData();
        element4.onCheckOut();
        ...
        final PropertyElement checkOut4 = PropertyElement.checkOut();
        checkOut4.setElementMap(elementMap);
        checkOut4.setName("mergeGem.itemTypeUp.quantityNeeded");
        checkOut4.setAttribute("text");
        element5.addBasicElement(checkOut4);
        checkOut4.onAttributesInitialized();
        checkOut4.onChildrenAdded();
    ...
    public BasicElement method58(final BasicElement basicElement) {
        ...
        checkOut14.setName("mergeGem.itemTypeUp");
    ...
    public BasicElement method59(final BasicElement basicElement) {
        ...
        checkOut3.setElementMap(elementMap);
        checkOut3.setExpandable(false);
        checkOut3.setPrefSize(new Dimension(40, 0));
        checkOut.addBasicElement(checkOut3);
        checkOut3.onAttributesInitialized();
        final RowLayoutData element2 = new RowLayoutData();
        element2.onCheckOut();
        ...
        textEditor.setRestrict("[0-9]+");
        final KeyTypedListener onKeyType = new KeyTypedListener();
        onKeyType.setCallBackFunc("wakfu.mergeGem:setCurrentCraftNumber(quantity2,2)");
        textEditor.setOnKeyType(onKeyType);
        checkOut3.addBasicElement(textEditor);
        textEditor.onAttributesInitialized();
        textEditor.onChildrenAdded();
        final String id2 = "maxButton2";
        ...
        final MouseClickedListener onClick = new MouseClickedListener();
        onClick.setCallBackFunc("wakfu.mergeGem:setCurrentCraftMaxNumber(2)");
        ...
        element6.onCheckOut();
        element6.setElementMap(elementMap);
        element6.setDisplayType(ProgressBar.ProgressBarDisplayType.CIRCLE);
        ...
        checkOut7.setColor(new Color(0.43f, 0.42f, 0.37f, 1.0f));
        appearance.addBasicElement(checkOut7);
        checkOut7.onAttributesInitialized();
        checkOut7.onChildrenAdded();
        appearance.onChildrenAdded();
        element6.onChildrenAdded();
        final String id3 = "progressBar2";
        ...
        checkOut6.addBasicElement(progressBar);
        progressBar.onAttributesInitialized();
        final StaticLayoutData element8 = new StaticLayoutData();
        element8.onCheckOut();
        element8.setElementMap(elementMap);
        element8.setAlign(Alignment17.CENTER);
        element8.setSize(new Dimension(72, 72));
        progressBar.addBasicElement(element8);
        element8.onAttributesInitialized();
        element8.onChildrenAdded();
        ...
        checkOut8.setElementMap(elementMap);
        checkOut8.setName("progressBar");
        checkOut8.setColor(new Color(0.38f, 1.0f, 0.92f, 1.0f));
        ...
        element9.onCheckOut();
        element9.setElementMap(elementMap);
        element9.setStyle("CraftControlBackground");
        element9.setNonBlocking(true);
        ...
        final MouseClickedListener onClick2 = new MouseClickedListener();
        onClick2.setCallBackFunc("wakfu.mergeGem:startCraft(progressBar2,2)");
        toggleButton.setOnClick(onClick2);
        checkOut9.addBasicElement(toggleButton);
        ...
        checkOut11.setName("mergeGem.item");
        toggleButton.addBasicElement(checkOut11);
        checkOut11.onAttributesInitialized();
        final ConditionResult element14 = new ConditionResult();
        element14.onCheckOut();
        element14.setElementMap(elementMap);
        ...
        checkOut14.setName("mergeGem.running");
        element16.addBasicElement(checkOut14);
        checkOut14.onAttributesInitialized();
        final ConditionResult element17 = new ConditionResult();
        element17.onCheckOut();
        element17.setElementMap(elementMap);
        element17.setValue("%desc.cancel%".replace("%desc.cancel%", Xulor.getInstance().getTranslatedString("desc.cancel")));
        element17.setElseValue("%desc.startGemCreate%".replace("%desc.startGemCreate%", Xulor.getInstance().getTranslatedString("desc.startGemCreate")));
        ...
        checkOut15.setElementMap(elementMap);
        checkOut15.setAttribute("visible");
        checkOut15.setName("mergeGem.running");
        ...
        checkOut16.setName("currentCraftNb");
    ...
    public BasicElement method63(final BasicElement basicElement) {
        ...
        element3.setElementMap(elementMap);
        element3.setStyle("white");
        element3.setText("%mergePowder.description%".replace("%mergePowder.description%", Xulor.getInstance().getTranslatedString("mergePowder.description")));
