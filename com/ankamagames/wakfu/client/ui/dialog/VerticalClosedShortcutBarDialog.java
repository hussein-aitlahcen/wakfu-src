...
public class VerticalClosedShortcutBarDialog implements BasicElementFactory
{
    private Stack<ElementMap> elementMaps;
    private Environment env;
    
    public VerticalClosedShortcutBarDialog() {
        super();
    ...
    public BasicElement getElement(final Environment env, final ElementMap item) {
        ...
        element.setPrefSize(new Dimension(0, 47));
    ...
    public BasicElement method20(final BasicElement basicElement) {
        ...
        element2.onCheckOut();
        element2.setElementMap(elementMap);
        element2.setInsets(new Insets(1, 10, 1, 10));
        ...
        element5.setElementMap(elementMap);
        element5.setExpandable(false);
        element5.setPrefSize(new Dimension(0, 31));
        element5.setScrollBar(false);
        element5.setCellSize(new Dimension(31, 39));
        ...
        element5.setOnDropOut(onDropOut);
        ...
        element12.onCheckOut();
        element12.setElementMap(elementMap);
        element12.setInsets(new Insets(4, 0, 4, 0));
        ...
        element14.setOnItemOver(onItemOver);
        ...
        element14.setOnItemOut(onItemOut);
        ...
        element14.setOnItemDoubleClick(onItemDoubleClick);
        ...
        final PropertyElement checkOut8 = PropertyElement.checkOut();
        checkOut8.setElementMap(elementMap);
        checkOut8.setAttribute("dragEnabled");
        ...
        checkOut9.setName("isInFightPlacement");
        ...
        checkOut11.setElementMap(elementMap);
        element25.addBasicElement(checkOut11);
        checkOut11.onAttributesInitialized();
        ...
        checkOut13.setElementMap(elementMap);
        checkOut13.setInsets(new Insets(0, 5, 6, 0));
        ...
        final Container checkOut14 = Container.checkOut();
        checkOut14.setElementMap(elementMap);
        checkOut14.setStyle("fighterControlsNotAllowed");
        ...
        checkOut15.onAttributesInitialized();
        final RowLayoutData element41 = new RowLayoutData();
        element41.onCheckOut();
        element41.setElementMap(elementMap);
        element41.setAlign(Alignment9.CENTER);
        ...
        checkOut17.setName("shortcutBar");
        checkOut17.setAttribute("text");
        checkOut17.setField("indexText");
        element42.addBasicElement(checkOut17);
        checkOut17.onAttributesInitialized();
        checkOut17.onChildrenAdded();
        element42.onChildrenAdded();
        checkOut15.onChildrenAdded();
        checkOut3.onChildrenAdded();
        final List element43 = new List();
        element43.onCheckOut();
        element43.setElementMap(elementMap);
        element43.setPrefSize(new Dimension(0, 31));
        element43.setScrollBar(false);
        element43.setCellSize(new Dimension(31, 39));
        element43.setHorizontal(true);
        element43.setAutoIdealSize(true);
        element43.setIdealSizeMinRows(1);
        element43.setIdealSizeMaxRows(1);
        element43.setNonBlocking(true);
        checkOut2.addBasicElement(element43);
        ...
        checkOut18.setName("shortcutBar");
        checkOut18.setAttribute("content");
        checkOut18.setField("keyList");
        element43.addBasicElement(checkOut18);
        checkOut18.onAttributesInitialized();
        checkOut18.onChildrenAdded();
        this.method21(element43);
