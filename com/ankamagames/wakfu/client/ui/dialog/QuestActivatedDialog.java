...
public class QuestActivatedDialog implements BasicElementFactory
{
    private Stack<ElementMap> elementMaps;
    private Environment env;
    
    public QuestActivatedDialog() {
        super();
    ...
    public BasicElement method32(final BasicElement basicElement) {
        ...
        element.setText("%desc.close%".replace("%desc.close%", Xulor.getInstance().getTranslatedString("desc.close")));
