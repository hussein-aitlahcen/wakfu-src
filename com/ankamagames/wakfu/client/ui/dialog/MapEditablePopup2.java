...
public class MapEditablePopup2 implements BasicElementFactory
{
    private Stack<ElementMap> elementMaps;
    private Environment env;
    
    public MapEditablePopup2() {
        super();
    ...
    public BasicElement getElement(final Environment env, final ElementMap item) {
        ...
        element.setHotSpotPosition(Alignment9.SOUTH_EAST);
        ...
        image.setStyle("BubbleArrowRight");
