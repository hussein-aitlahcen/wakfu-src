...
public class MergeGemDialog implements BasicElementFactory
{
    private Stack<ElementMap> elementMaps;
    private Environment env;
    
    public MergeGemDialog() {
        super();
    ...
    public BasicElement getElement(final Environment env, final ElementMap item) {
        ...
        element14.setPrefSize(new Dimension(250, 280));
        ...
        element16.setIdealSizeMaxColumns(6);
        element16.setIdealSizeMinColumns(6);
    ...
    public BasicElement method54(final BasicElement basicElement) {
        ...
        checkOut4.setElementMap(elementMap);
        checkOut4.setExpandable(false);
        checkOut4.setPrefSize(new Dimension(40, 0));
        checkOut2.addBasicElement(checkOut4);
        checkOut4.onAttributesInitialized();
        ...
        textEditor.setRestrict("[0-9]+");
        final KeyTypedListener onKeyType = new KeyTypedListener();
        onKeyType.setCallBackFunc("wakfu.mergeGem:setCurrentCraftNumber(quantity0,0)");
        textEditor.setOnKeyType(onKeyType);
        checkOut4.addBasicElement(textEditor);
        textEditor.onAttributesInitialized();
        textEditor.onChildrenAdded();
        final String id2 = "maxButton0";
        ...
        final MouseClickedListener onClick = new MouseClickedListener();
        onClick.setCallBackFunc("wakfu.mergeGem:setCurrentCraftMaxNumber(0)");
        ...
        element5.onCheckOut();
        element5.setElementMap(elementMap);
        element5.setPrefSize(new Dimension(45, 45));
        element5.setEnableDND(false);
        checkOut2.addBasicElement(element5);
        element5.onAttributesInitialized();
        final ItemRenderer element6 = new ItemRenderer();
        element6.onCheckOut();
        ...
        element11.onCheckOut();
        element11.setElementMap(elementMap);
        element11.setInsets(new Insets(4, 5, 5, 4));
        appearance2.addBasicElement(element11);
        element11.onAttributesInitialized();
        element11.onChildrenAdded();
        appearance2.onChildrenAdded();
        ...
        element16.onCheckOut();
        element16.setElementMap(elementMap);
        element16.setDropEnabled(false);
        ...
        element18.setScaled(true);
        element18.setShrinkable(true);
        element16.addBasicElement(element18);
        element18.onAttributesInitialized();
        ...
        element26.onCheckOut();
        element26.setElementMap(elementMap);
        element5.addBasicElement(element26);
        element26.onAttributesInitialized();
        final ConditionResult element27 = new ConditionResult();
        element27.onCheckOut();
        element27.setElementMap(elementMap);
        ...
        element32.setDropEnabled(false);
        ...
        final Margin checkOut17 = Margin.checkOut();
        checkOut17.setElementMap(elementMap);
        checkOut17.setInsets(new Insets(3, 3, 3, 3));
        ...
        checkOut19.setName("mergeGem.itemLevelUp");
        ...
        checkOut20.setElementMap(elementMap);
        final PopupDisplayListener onPopupDisplay3 = new PopupDisplayListener();
        onPopupDisplay3.setCallBackFunc("popup(quantityDesc2)");
        checkOut20.setOnPopupDisplay(onPopupDisplay3);
        final PopupHideListener onPopupHide3 = new PopupHideListener();
        onPopupHide3.setCallBackFunc("closePopup");
        checkOut20.setOnPopupHide(onPopupHide3);
        checkOut20.setNonBlocking(false);
        checkOut2.addBasicElement(checkOut20);
        checkOut20.onAttributesInitialized();
        final String id6 = "quantityDesc2";
        ...
        checkOut20.addBasicElement(popupElement3);
        popupElement3.onAttributesInitialized();
        this.method55(popupElement3);
        popupElement3.onChildrenAdded();
        this.method56(checkOut20);
        this.method57(checkOut20);
        this.method58(checkOut20);
        this.method59(checkOut20);
        checkOut20.onChildrenAdded();
        this.method60(checkOut2);
        this.method61(checkOut2);
        this.method62(checkOut2);
        this.method63(checkOut2);
        checkOut2.onChildrenAdded();
        this.method64(checkOut);
        this.method65(checkOut);
        checkOut.onChildrenAdded();
        return checkOut;
    }
    ...
    public BasicElement method58(final BasicElement basicElement) {
        ...
        element.onCheckOut();
        element.setElementMap(elementMap);
        element.setStyle("collectMachineRightArrow");
        basicElement.addBasicElement(element);
        element.onAttributesInitialized();
        final StaticLayoutData element2 = new StaticLayoutData();
        element2.onCheckOut();
    ...
    public BasicElement method59(final BasicElement basicElement) {
        ...
        final PropertyElement checkOut = PropertyElement.checkOut();
        checkOut.setElementMap(elementMap);
        checkOut.setName("mergeGem.itemLevelUp.quantityNeeded");
    ...
    public BasicElement method60(final BasicElement basicElement) {
        ...
        element24.onCheckOut();
        element24.setElementMap(elementMap);
        renderableContainer.addBasicElement(element24);
        element24.onAttributesInitialized();
        final ConditionResult element25 = new ConditionResult();
        element25.onCheckOut();
        element25.setElementMap(elementMap);
        ...
        element30.setExpandable(false);
        element30.setText("%mergeGem.insertGem%".replace("%mergeGem.insertGem%", Xulor.getInstance().getTranslatedString("mergeGem.insertGem")));
        ...
        element33.onAttributesInitialized();
        final DecoratorAppearance appearance6 = element33.getAppearance();
        appearance6.setElementMap(elementMap);
        appearance6.setModulationColor(new Color(1.0f, 1.0f, 1.0f, 0.5f));
        element33.addBasicElement(appearance6);
        appearance6.onAttributesInitialized();
        appearance6.onChildrenAdded();
        ...
        checkOut18.setStyle("ItemBackgroundPerfectVariant");
        ...
        checkOut19.setElementMap(elementMap);
        checkOut19.setAttribute("content");
        checkOut19.setName("mergeGem.item");
        renderableContainer.addBasicElement(checkOut19);
        checkOut19.onAttributesInitialized();
        checkOut19.onChildrenAdded();
        final PropertyElement checkOut20 = PropertyElement.checkOut();
        checkOut20.setElementMap(elementMap);
        checkOut20.setName("mergeGem.running");
        checkOut20.setAttribute("enableDND");
        renderableContainer.addBasicElement(checkOut20);
        checkOut20.onAttributesInitialized();
        final ConditionResult element35 = new ConditionResult();
        element35.onCheckOut();
        element35.setElementMap(elementMap);
    ...
    public BasicElement method61(final BasicElement basicElement) {
        ...
        element5.onCheckOut();
        element5.setElementMap(elementMap);
        element5.setStyle("SmallBoldBordered12");
        checkOut.addBasicElement(element5);
        element5.onAttributesInitialized();
        final StaticLayoutData element6 = new StaticLayoutData();
        element6.onCheckOut();
        ...
        final PropertyElement checkOut4 = PropertyElement.checkOut();
        checkOut4.setElementMap(elementMap);
        checkOut4.setName("mergeGem.itemRarityUp.quantityNeeded");
        checkOut4.setAttribute("text");
        element5.addBasicElement(checkOut4);
        checkOut4.onAttributesInitialized();
        checkOut4.onChildrenAdded();
    ...
    public BasicElement method63(final BasicElement basicElement) {
        ...
        textEditor.setRestrict("[0-9]+");
        final KeyTypedListener onKeyType = new KeyTypedListener();
        onKeyType.setCallBackFunc("wakfu.mergeGem:setCurrentCraftNumber(quantity1,1)");
        textEditor.setOnKeyType(onKeyType);
        checkOut.addBasicElement(textEditor);
        textEditor.onAttributesInitialized();
        textEditor.onChildrenAdded();
        final String id2 = "maxButton1";
        final Button button = new Button();
        button.onCheckOut();
        button.setElementMap(elementMap);
        if (elementMap != null && id2 != null) {
        ...
        button.setText("%max%".replace("%max%", Xulor.getInstance().getTranslatedString("max")));
        final MouseClickedListener onClick = new MouseClickedListener();
        onClick.setCallBackFunc("wakfu.mergeGem:setCurrentCraftMaxNumber(1)");
        button.setOnClick(onClick);
