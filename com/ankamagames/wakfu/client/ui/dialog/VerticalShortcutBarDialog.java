...
public class VerticalShortcutBarDialog implements BasicElementFactory
{
    private Stack<ElementMap> elementMaps;
    private Environment env;
    
    public VerticalShortcutBarDialog() {
        super();
    ...
    public BasicElement method28(final BasicElement basicElement) {
        ...
        element2.onCheckOut();
        element2.setElementMap(elementMap);
        element2.setInsets(new Insets(7, 5, 10, 5));
        ...
        checkOut7.setField("currentShortcutBarType");
        ...
        checkOut5.addBasicElement(toggleButton2);
        ...
        checkOut15.setName("shortcutBarManager");
        checkOut15.setField("currentShortcutBarType");
        ...
        checkOut17.setStyle("ShortcutBarBoxBackgroundVertical");
        ...
        checkOut18.setStyle("ShortcutBarBoxBackgroundVertical");
        ...
        this.method29(checkOut18);
        this.method30(checkOut18);
        this.method31(checkOut18);
        checkOut18.onChildrenAdded();
        element20.onChildrenAdded();
        this.method32(renderableContainer);
        this.method33(renderableContainer);
        renderableContainer.onChildrenAdded();
        this.method34(checkOut14);
        checkOut14.onChildrenAdded();
        this.method35(checkOut3);
        this.method36(checkOut3);
    ...
    public BasicElement method34(final BasicElement basicElement) {
        ...
        checkOut.setStyle("ShortcutBarBoxBackgroundVertical");
        element.addBasicElement(checkOut);
        checkOut.onAttributesInitialized();
        final String id3 = "bg";
        final Image image = new Image();
        ...
        checkOut2.setStyle("ShortcutBarBoxBackgroundVertical");
    ...
    public BasicElement method36(final BasicElement basicElement) {
        ...
        list.setPrefSize(new Dimension(39, 0));
        ...
        element.setSize(new Dimension(39, 390));
        ...
        checkOut.setAttribute("content");
        checkOut.setName("shortcutBarManager");
        checkOut.setField("selectedShortcutBar/shortcuts");
        ...
        checkOut3.setStyle("ShortcutBarBoxBackgroundVertical");
        ...
        final PropertyElement checkOut4 = PropertyElement.checkOut();
        checkOut4.setElementMap(elementMap);
        checkOut4.setAttribute("dragEnabled");
        ...
        checkOut5.setName("isInFightPlacement");
        element19.addBasicElement(checkOut5);
        checkOut5.onAttributesInitialized();
        checkOut5.onChildrenAdded();
        element19.onChildrenAdded();
        element17.onChildrenAdded();
        ...
        checkOut6.setElementMap(elementMap);
        element21.addBasicElement(checkOut6);
        checkOut6.onAttributesInitialized();
        ...
        checkOut8.setElementMap(elementMap);
        checkOut8.setInsets(new Insets(0, 0, 7, 6));
        ...
        checkOut9.setElementMap(elementMap);
        checkOut9.setStyle("fighterControlsNotAllowed");
    ...
    public BasicElement method37(final BasicElement basicElement) {
        ...
        button.setStyle("smallLeftsideArrow1");
        final MouseClickedListener onClick = new MouseClickedListener();
        ...
        element2.setText("%desc.actionShortcutsPrevious% (F1-F4)".replace("%desc.actionShortcutsPrevious%", Xulor.getInstance().getTranslatedString("desc.actionShortcutsPrevious")));
        ...
        element6.setText("%desc.additionalShortcutBar% (Ctrl+F1-F4)".replace("%desc.additionalShortcutBar%", Xulor.getInstance().getTranslatedString("desc.additionalShortcutBar")));
        element6.setExpandable(false);
        ...
        button2.setStyle("smallRightsideArrow1");
        ...
        element9.setElementMap(elementMap);
        element9.setStyle("PopupInformation");
        element9.setText("%desc.actionShortcutsNext% (F1-F4)".replace("%desc.actionShortcutsNext%", Xulor.getInstance().getTranslatedString("desc.actionShortcutsNext")));
        element9.setExpandable(false);
    ...
    public BasicElement method38(final BasicElement basicElement) {
        ...
        element.onCheckOut();
        element.setElementMap(elementMap);
        element.setPrefSize(new Dimension(39, 0));
        ...
        element2.setSize(new Dimension(39, 390));
        element.addBasicElement(element2);
        element2.onAttributesInitialized();
        final PropertyElement checkOut = PropertyElement.checkOut();
        checkOut.setElementMap(elementMap);
        ...
        element5.onCheckOut();
        element5.setElementMap(elementMap);
        element5.setValue("39,312");
        element5.setElseValue("39,390");
        ...
        final Margin checkOut5 = Margin.checkOut();
        checkOut5.setElementMap(elementMap);
        checkOut5.setInsets(new Insets(4, 4, 0, 0));
        appearance.addBasicElement(checkOut5);
        checkOut5.onAttributesInitialized();
        checkOut5.onChildrenAdded();
        appearance.onChildrenAdded();
