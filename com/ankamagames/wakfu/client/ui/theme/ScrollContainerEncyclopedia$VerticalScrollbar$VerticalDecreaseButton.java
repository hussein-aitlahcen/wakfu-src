...
public class ScrollContainerEncyclopedia$VerticalScrollbar$VerticalDecreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ScrollContainerEncyclopedia$VerticalScrollbar$VerticalDecreaseButton() {
        super();
