...
public class TextViewRedBold$ScrollContainer$HorizontalScrollbar$HorizontalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewRedBold$ScrollContainer$HorizontalScrollbar$HorizontalSlider() {
        super();
