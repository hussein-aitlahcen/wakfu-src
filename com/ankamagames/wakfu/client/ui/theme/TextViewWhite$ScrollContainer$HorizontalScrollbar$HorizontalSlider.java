...
public class TextViewWhite$ScrollContainer$HorizontalScrollbar$HorizontalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewWhite$ScrollContainer$HorizontalScrollbar$HorizontalSlider() {
        super();
