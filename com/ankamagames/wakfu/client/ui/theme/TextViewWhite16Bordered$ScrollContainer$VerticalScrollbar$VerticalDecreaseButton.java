...
public class TextViewWhite16Bordered$ScrollContainer$VerticalScrollbar$VerticalDecreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewWhite16Bordered$ScrollContainer$VerticalScrollbar$VerticalDecreaseButton() {
        super();
