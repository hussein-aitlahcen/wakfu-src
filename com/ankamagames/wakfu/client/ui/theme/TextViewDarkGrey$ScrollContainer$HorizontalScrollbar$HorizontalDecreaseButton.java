...
public class TextViewDarkGrey$ScrollContainer$HorizontalScrollbar$HorizontalDecreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewDarkGrey$ScrollContainer$HorizontalScrollbar$HorizontalDecreaseButton() {
        super();
