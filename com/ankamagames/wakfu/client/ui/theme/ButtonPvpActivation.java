...
public class ButtonPvpActivation implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonPvpActivation() {
        super();
