...
public class ContainerDimensionalBagRoomManagerCellElement implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerDimensionalBagRoomManagerCellElement() {
        super();
