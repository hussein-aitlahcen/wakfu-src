...
public class ContainerItemVirtualBackground implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerItemVirtualBackground() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        appearance.setModulationColor(new Color(1.0f, 0.8f, 0.8f, 1.0f));
