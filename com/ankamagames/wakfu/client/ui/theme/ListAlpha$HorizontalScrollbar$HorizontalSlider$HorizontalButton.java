...
public class ListAlpha$HorizontalScrollbar$HorizontalSlider$HorizontalButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ListAlpha$HorizontalScrollbar$HorizontalSlider$HorizontalButton() {
        super();
