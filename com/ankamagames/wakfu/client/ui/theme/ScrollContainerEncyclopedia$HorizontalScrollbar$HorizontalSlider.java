...
public class ScrollContainerEncyclopedia$HorizontalScrollbar$HorizontalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ScrollContainerEncyclopedia$HorizontalScrollbar$HorizontalSlider() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        checkOut31.setInsets(new Insets(3, 5, 3, 5));
        appearance.addBasicElement(checkOut31);
