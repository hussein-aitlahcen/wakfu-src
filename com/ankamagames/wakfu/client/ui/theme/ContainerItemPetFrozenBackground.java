...
public class ContainerItemPetFrozenBackground implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerItemPetFrozenBackground() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        appearance.setModulationColor(new Color(0.6f, 0.9f, 1.0f, 1.0f));
