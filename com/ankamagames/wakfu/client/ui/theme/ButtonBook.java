...
public class ButtonBook implements StyleSetter
{
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        checkOut.setHeight(57);
        checkOut.setPosition(Alignment17.CENTER);
        checkOut.setTexture(this.doc.getTexture("quest_0.tga"));
        checkOut.setWidth(87);
        checkOut.setX(2);
        checkOut.setY(5);
