...
public class TextViewWhiteBordered$ScrollContainer$VerticalScrollbar$VerticalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewWhiteBordered$ScrollContainer$VerticalScrollbar$VerticalIncreaseButton() {
        super();
