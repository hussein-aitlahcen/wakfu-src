...
public class TextViewWhiteBordered$ScrollContainer$HorizontalScrollbar$HorizontalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewWhiteBordered$ScrollContainer$HorizontalScrollbar$HorizontalSlider() {
        super();
