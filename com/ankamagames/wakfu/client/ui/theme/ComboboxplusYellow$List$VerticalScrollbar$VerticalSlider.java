...
public class ComboboxplusYellow$List$VerticalScrollbar$VerticalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusYellow$List$VerticalScrollbar$VerticalSlider() {
        super();
