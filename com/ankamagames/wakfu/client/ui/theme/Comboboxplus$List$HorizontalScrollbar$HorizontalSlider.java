...
public class Comboboxplus$List$HorizontalScrollbar$HorizontalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public Comboboxplus$List$HorizontalScrollbar$HorizontalSlider() {
        super();
