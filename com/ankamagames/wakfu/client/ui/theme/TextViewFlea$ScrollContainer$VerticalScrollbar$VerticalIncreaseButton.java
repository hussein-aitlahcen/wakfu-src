...
public class TextViewFlea$ScrollContainer$VerticalScrollbar$VerticalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewFlea$ScrollContainer$VerticalScrollbar$VerticalIncreaseButton() {
        super();
