...
public class RadioButtonScroll implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public RadioButtonScroll() {
        super();
