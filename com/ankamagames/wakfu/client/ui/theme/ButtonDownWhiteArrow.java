...
public class ButtonDownWhiteArrow implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonDownWhiteArrow() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "smallWhiteBottomArrowDefault";
        ...
        final String id2 = "smallWhiteBottomArrowOver";
        ...
        final String id3 = "smallWhiteBottomArrowPressed";
        ...
        final String id4 = "smallWhiteBottomArrowDisabled";
