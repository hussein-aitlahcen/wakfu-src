...
public class ComboboxplusChat$List$VerticalScrollbar$VerticalDecreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusChat$List$VerticalScrollbar$VerticalDecreaseButton() {
        super();
