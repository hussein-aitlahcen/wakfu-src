...
public class ComboBoxPlusWebShop$List$HorizontalScrollbar$HorizontalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboBoxPlusWebShop$List$HorizontalScrollbar$HorizontalIncreaseButton() {
        super();
