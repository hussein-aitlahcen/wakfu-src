...
public class ComboboxplusLanguage$List$HorizontalScrollbar$HorizontalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusLanguage$List$HorizontalScrollbar$HorizontalSlider() {
        super();
