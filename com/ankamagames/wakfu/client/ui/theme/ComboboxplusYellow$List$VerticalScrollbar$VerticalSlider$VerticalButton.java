...
public class ComboboxplusYellow$List$VerticalScrollbar$VerticalSlider$VerticalButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusYellow$List$VerticalScrollbar$VerticalSlider$VerticalButton() {
        super();
