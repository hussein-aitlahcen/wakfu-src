...
public class ComboboxplusBlue2$List$VerticalScrollbar$VerticalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusBlue2$List$VerticalScrollbar$VerticalIncreaseButton() {
        super();
