...
public class ScrollContainer$VerticalScrollbar$VerticalSlider$VerticalButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ScrollContainer$VerticalScrollbar$VerticalSlider$VerticalButton() {
        super();
