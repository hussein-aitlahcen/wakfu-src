...
public class ComboboxplusChat$List$HorizontalScrollbar$HorizontalDecreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusChat$List$HorizontalScrollbar$HorizontalDecreaseButton() {
        super();
