...
public class ContainerCompanionSelectedPane implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerCompanionSelectedPane() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        checkOut2.setTexture(this.doc.getTexture("companion_0.tga"));
        ...
        checkOut3.setTexture(this.doc.getTexture("companion_0.tga"));
        ...
        checkOut4.setTexture(this.doc.getTexture("companion_0.tga"));
        ...
        checkOut5.setTexture(this.doc.getTexture("companion_0.tga"));
        checkOut5.setWidth(31);
        checkOut5.setX(151);
        checkOut5.setY(94);
        ...
        checkOut6.setTexture(this.doc.getTexture("companion_0.tga"));
        ...
        checkOut7.setTexture(this.doc.getTexture("companion_0.tga"));
        ...
        checkOut8.setHeight(31);
        checkOut8.setPosition(Alignment17.SOUTH_WEST);
        checkOut8.setTexture(this.doc.getTexture("companion_0.tga"));
        checkOut8.setWidth(31);
        checkOut8.setX(196);
        checkOut8.setY(155);
        ...
        checkOut10.setHeight(31);
        checkOut10.setPosition(Alignment17.SOUTH_EAST);
        checkOut10.setTexture(this.doc.getTexture("companion_0.tga"));
        checkOut10.setWidth(34);
        checkOut10.setX(196);
        checkOut10.setY(189);
