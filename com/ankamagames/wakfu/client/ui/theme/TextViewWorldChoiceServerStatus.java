...
public class TextViewWorldChoiceServerStatus implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewWorldChoiceServerStatus() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        checkOut.setColor(new Color(0.9f, 0.06f, 0.06f, 1.0f));
