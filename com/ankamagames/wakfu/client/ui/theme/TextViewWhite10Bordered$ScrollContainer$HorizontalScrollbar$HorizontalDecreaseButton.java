...
public class TextViewWhite10Bordered$ScrollContainer$HorizontalScrollbar$HorizontalDecreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewWhite10Bordered$ScrollContainer$HorizontalScrollbar$HorizontalDecreaseButton() {
        super();
