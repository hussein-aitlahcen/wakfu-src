...
public class LabelSmallSpellDescriptionAP implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public LabelSmallSpellDescriptionAP() {
        super();
