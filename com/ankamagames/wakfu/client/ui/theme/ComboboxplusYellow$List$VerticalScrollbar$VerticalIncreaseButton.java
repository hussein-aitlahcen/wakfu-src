...
public class ComboboxplusYellow$List$VerticalScrollbar$VerticalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusYellow$List$VerticalScrollbar$VerticalIncreaseButton() {
        super();
