...
public class ButtonCharacterCreationRightArrow implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonCharacterCreationRightArrow() {
        super();
