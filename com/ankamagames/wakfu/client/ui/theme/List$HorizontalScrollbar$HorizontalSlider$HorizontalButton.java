...
public class List$HorizontalScrollbar$HorizontalSlider$HorizontalButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public List$HorizontalScrollbar$HorizontalSlider$HorizontalButton() {
        super();
