...
public class ComboboxplusChat$List$HorizontalScrollbar$HorizontalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusChat$List$HorizontalScrollbar$HorizontalSlider() {
        super();
