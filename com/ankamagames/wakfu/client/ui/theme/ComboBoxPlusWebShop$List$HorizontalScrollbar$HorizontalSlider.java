...
public class ComboBoxPlusWebShop$List$HorizontalScrollbar$HorizontalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboBoxPlusWebShop$List$HorizontalScrollbar$HorizontalSlider() {
        super();
