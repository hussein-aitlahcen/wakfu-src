...
public class Mru$ButtonEast implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public Mru$ButtonEast() {
        super();
