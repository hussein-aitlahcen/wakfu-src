...
public class ContainerProtector implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerProtector() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "protectorContainerBorder";
        ...
        final String id2 = "protectorContainerBackground";
