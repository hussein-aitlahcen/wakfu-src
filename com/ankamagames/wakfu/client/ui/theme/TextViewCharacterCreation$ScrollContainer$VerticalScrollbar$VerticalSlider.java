...
public class TextViewCharacterCreation$ScrollContainer$VerticalScrollbar$VerticalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewCharacterCreation$ScrollContainer$VerticalScrollbar$VerticalSlider() {
        super();
