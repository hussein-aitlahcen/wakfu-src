...
public class ButtonChangeDirectionSW implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonChangeDirectionSW() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "pmChangeDirectionSWDefault";
        ...
        final String id2 = "pmChangeDirectionSWOver";
        ...
        final String id3 = "pmChangeDirectionSWPressed";
        ...
        final String id4 = "pmChangeDirectionSWDisabled";
