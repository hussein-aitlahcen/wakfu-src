...
public class TextViewWhite18Bordered implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewWhite18Bordered() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        checkOut2.setRenderer(Xulor.getInstance().getDocumentParser().getFont("narrowFont18Bordered"));
