...
public class ComboBoxPlusWebShop$List$VerticalScrollbar$VerticalDecreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboBoxPlusWebShop$List$VerticalScrollbar$VerticalDecreaseButton() {
        super();
