...
public class ContainerProtectorFrameOver implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerProtectorFrameOver() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "styledContainerBackground";
        ...
        checkOut8.setRotation(GeometrySprite.SpriteRotation.HALF);
