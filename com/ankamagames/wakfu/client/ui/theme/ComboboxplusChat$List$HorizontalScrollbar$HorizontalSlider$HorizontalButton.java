...
public class ComboboxplusChat$List$HorizontalScrollbar$HorizontalSlider$HorizontalButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusChat$List$HorizontalScrollbar$HorizontalSlider$HorizontalButton() {
        super();
