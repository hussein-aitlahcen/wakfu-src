...
public class ContainerScrollString implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerScrollString() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "scrollStringBackground";
        ...
        final String id2 = "scrollStringBorder";
