...
public class ComboboxplusChat implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusChat() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final Widget widgetByThemeElementName2 = appearance.getParentOfType(Widget.class).getWidgetByThemeElementName("list", false);
        if (widgetByThemeElementName2 != null) {
            ...
            appearance3.addBasicElement(element);
            ...
            final Widget widgetByThemeElementName3 = appearance3.getParentOfType(Widget.class).getWidgetByThemeElementName("horizontalScrollbar", false);
            if (widgetByThemeElementName3 != null) {
                final DecoratorAppearance appearance4 = widgetByThemeElementName3.getAppearance();
                appearance4.setElementMap(elementMap);
                widgetByThemeElementName3.addBasicElement(appearance4);
                appearance4.onAttributesInitialized();
                final Widget widgetByThemeElementName4 = appearance4.getParentOfType(Widget.class).getWidgetByThemeElementName("horizontalIncreaseButton", false);
                if (widgetByThemeElementName4 != null) {
                    final Padding element2 = new Padding();
                    element2.onCheckOut();
                    element2.setElementMap(elementMap);
                    element2.setInsets(new Insets(1, 1, 1, 1));
                    widgetByThemeElementName4.addBasicElement(element2);
                    element2.onAttributesInitialized();
                    element2.onChildrenAdded();
                    final DecoratorAppearance appearance5 = widgetByThemeElementName4.getAppearance();
                    appearance5.setElementMap(elementMap);
                    appearance5.setState("default");
                    widgetByThemeElementName4.addBasicElement(appearance5);
                    ...
                    final DecoratorAppearance appearance6 = widgetByThemeElementName4.getAppearance();
                    appearance6.setElementMap(elementMap);
                    appearance6.setState("mouseHover");
                    widgetByThemeElementName4.addBasicElement(appearance6);
                    ...
                    final DecoratorAppearance appearance7 = widgetByThemeElementName4.getAppearance();
                    appearance7.setElementMap(elementMap);
                    appearance7.setState("pressed");
                    widgetByThemeElementName4.addBasicElement(appearance7);
                ...
                final Widget widgetByThemeElementName5 = appearance4.getParentOfType(Widget.class).getWidgetByThemeElementName("horizontalDecreaseButton", false);
                if (widgetByThemeElementName5 != null) {
                    final Padding element3 = new Padding();
                    element3.onCheckOut();
                    element3.setElementMap(elementMap);
                    element3.setInsets(new Insets(1, 1, 1, 1));
                    widgetByThemeElementName5.addBasicElement(element3);
                    element3.onAttributesInitialized();
                    element3.onChildrenAdded();
                    final DecoratorAppearance appearance8 = widgetByThemeElementName5.getAppearance();
                    appearance8.setElementMap(elementMap);
                    appearance8.setState("default");
                    widgetByThemeElementName5.addBasicElement(appearance8);
                    appearance8.onAttributesInitialized();
                    final PixmapElement checkOut14 = PixmapElement.checkOut();
                    checkOut14.setElementMap(elementMap);
                    checkOut14.setHeight(12);
                    ...
                    appearance9.setState("mouseHover");
                ...
                final Widget widgetByThemeElementName6 = appearance4.getParentOfType(Widget.class).getWidgetByThemeElementName("horizontalSlider", false);
                if (widgetByThemeElementName6 != null) {
                    final DecoratorAppearance appearance11 = widgetByThemeElementName6.getAppearance();
                    appearance11.setElementMap(elementMap);
                    widgetByThemeElementName6.addBasicElement(appearance11);
                    appearance11.onAttributesInitialized();
                    final Widget widgetByThemeElementName7 = appearance11.getParentOfType(Widget.class).getWidgetByThemeElementName("horizontalButton", false);
                    if (widgetByThemeElementName7 != null) {
                        final DecoratorAppearance appearance12 = widgetByThemeElementName7.getAppearance();
                        appearance12.setElementMap(elementMap);
                        appearance12.setState("default");
                        widgetByThemeElementName7.addBasicElement(appearance12);
                        appearance12.onAttributesInitialized();
                        final PixmapBorder element4 = new PixmapBorder();
                        element4.onCheckOut();
                        element4.setElementMap(elementMap);
                        appearance12.addBasicElement(element4);
                        ...
                        checkOut27.setHeight(6);
                        checkOut27.setPosition(Alignment17.CENTER);
                        checkOut27.setRotation(GeometrySprite.SpriteRotation.QUARTER_CLOCKWISE);
                        ...
                        final DecoratorAppearance appearance13 = widgetByThemeElementName7.getAppearance();
                        appearance13.setElementMap(elementMap);
                        appearance13.setState("mouseHover");
                        widgetByThemeElementName7.addBasicElement(appearance13);
                        appearance13.onAttributesInitialized();
                        final PixmapBorder element5 = new PixmapBorder();
                        element5.onCheckOut();
                        element5.setElementMap(elementMap);
                        appearance13.addBasicElement(element5);
                        ...
                        checkOut33.setTexture(this.doc.getTexture("default_0.tga"));
                        ...
                        this.method1(element5);
                        element5.onChildrenAdded();
                        this.method2(appearance13);
                        this.method3(appearance13);
                        appearance13.onChildrenAdded();
                        this.method4(widgetByThemeElementName7);
                    }
