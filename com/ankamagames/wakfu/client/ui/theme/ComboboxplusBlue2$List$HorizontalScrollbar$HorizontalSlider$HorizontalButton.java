...
public class ComboboxplusBlue2$List$HorizontalScrollbar$HorizontalSlider$HorizontalButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusBlue2$List$HorizontalScrollbar$HorizontalSlider$HorizontalButton() {
        super();
