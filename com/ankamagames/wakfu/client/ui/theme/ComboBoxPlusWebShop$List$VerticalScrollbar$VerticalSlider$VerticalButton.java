...
public class ComboBoxPlusWebShop$List$VerticalScrollbar$VerticalSlider$VerticalButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboBoxPlusWebShop$List$VerticalScrollbar$VerticalSlider$VerticalButton() {
        super();
