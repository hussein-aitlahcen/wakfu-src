...
public class RadioButtonCharacterCreationFemale implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public RadioButtonCharacterCreationFemale() {
        super();
