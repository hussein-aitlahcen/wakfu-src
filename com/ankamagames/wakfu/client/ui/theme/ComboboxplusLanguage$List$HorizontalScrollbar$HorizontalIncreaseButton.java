...
public class ComboboxplusLanguage$List$HorizontalScrollbar$HorizontalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusLanguage$List$HorizontalScrollbar$HorizontalIncreaseButton() {
        super();
