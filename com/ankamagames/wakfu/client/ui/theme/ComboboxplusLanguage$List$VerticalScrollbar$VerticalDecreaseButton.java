...
public class ComboboxplusLanguage$List$VerticalScrollbar$VerticalDecreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusLanguage$List$VerticalScrollbar$VerticalDecreaseButton() {
        super();
