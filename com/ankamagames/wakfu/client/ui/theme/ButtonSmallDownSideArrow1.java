...
public class ButtonSmallDownSideArrow1 implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonSmallDownSideArrow1() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "pmSmallDownSideArrow1Default";
        ...
        final String id2 = "pmSmallDownSideArrow1Over";
        ...
        final String id3 = "pmSmallDownSideArrow1Pressed";
        ...
        final String id4 = "pmSmallDownSideArrow1Disabled";
        ...
        final String id5 = "pmSmallDownSideArrow1DefaultSelected";
        ...
        final String id6 = "pmSmallDownSideArrow1OverSelected";
        ...
        final String id7 = "pmSmallDownSideArrow1PressedSelected";
        ...
        final String id8 = "pmSmallDownSideArrow1DisabledSelected";
