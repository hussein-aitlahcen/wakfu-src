...
public class ButtonRightTurnArrow implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonRightTurnArrow() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "rightTurnArrowDefault";
        ...
        final String id2 = "rightTurnArrowOver";
        ...
        final String id3 = "rightTurnArrowPressed";
