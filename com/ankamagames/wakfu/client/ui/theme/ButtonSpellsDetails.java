...
public class ButtonSpellsDetails implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonSpellsDetails() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "spellsDetailsButtonDefaultPixmap";
        ...
        final String id2 = "spellsDetailsButtonPressedPixmap";
        ...
        final String id3 = "spellsDetailsButtonOverPixmap";
        ...
        final String id4 = "spellsDetailsButtonDisabledPixmap";
