...
public class ButtonChangeDirectionNW implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonChangeDirectionNW() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "pmChangeDirectionNWDefault";
        ...
        final String id2 = "pmChangeDirectionNWOver";
        ...
        final String id3 = "pmChangeDirectionNWPressed";
        ...
        final String id4 = "pmChangeDirectionNWDisabled";
