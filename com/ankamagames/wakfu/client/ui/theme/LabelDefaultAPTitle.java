...
public class LabelDefaultAPTitle implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public LabelDefaultAPTitle() {
        super();
