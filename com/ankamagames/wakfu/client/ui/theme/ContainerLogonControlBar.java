...
public class ContainerLogonControlBar implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerLogonControlBar() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "logonControlBarContainerBackground";
        ...
        final String id2 = "logonControlBarContainerBorder";
        ...
        checkOut10.setX(1012);
        checkOut10.setY(1001);
