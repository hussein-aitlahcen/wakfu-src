...
public class TextViewDarkGrey$ScrollContainer$VerticalScrollbar$VerticalDecreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewDarkGrey$ScrollContainer$VerticalScrollbar$VerticalDecreaseButton() {
        super();
