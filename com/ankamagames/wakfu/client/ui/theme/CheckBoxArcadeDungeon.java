...
public class CheckBoxArcadeDungeon implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public CheckBoxArcadeDungeon() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        checkOut2.setTexture(this.doc.getTexture("arcadeDungeon_0.tga"));
        ...
        checkOut3.setTexture(this.doc.getTexture("arcadeDungeon_0.tga"));
        ...
        checkOut4.setTexture(this.doc.getTexture("arcadeDungeon_0.tga"));
        ...
        checkOut5.setTexture(this.doc.getTexture("arcadeDungeon_0.tga"));
        ...
        checkOut6.setTexture(this.doc.getTexture("arcadeDungeon_0.tga"));
        ...
        checkOut7.setTexture(this.doc.getTexture("arcadeDungeon_0.tga"));
        ...
        checkOut8.setTexture(this.doc.getTexture("arcadeDungeon_0.tga"));
