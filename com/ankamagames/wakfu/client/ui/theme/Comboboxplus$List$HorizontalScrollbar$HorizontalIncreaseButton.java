...
public class Comboboxplus$List$HorizontalScrollbar$HorizontalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public Comboboxplus$List$HorizontalScrollbar$HorizontalIncreaseButton() {
        super();
