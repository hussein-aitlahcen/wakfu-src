...
public class TabbedContainerDark$IncreaseButtonSouth implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TabbedContainerDark$IncreaseButtonSouth() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        element.setInsets(new Insets(1, 3, 0, 3));
