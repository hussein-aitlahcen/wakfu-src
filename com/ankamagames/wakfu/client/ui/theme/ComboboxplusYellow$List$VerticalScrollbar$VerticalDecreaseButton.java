...
public class ComboboxplusYellow$List$VerticalScrollbar$VerticalDecreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusYellow$List$VerticalScrollbar$VerticalDecreaseButton() {
        super();
