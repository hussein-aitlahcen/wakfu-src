...
public class TextViewWhite10Bordered$ScrollContainer$VerticalScrollbar$VerticalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewWhite10Bordered$ScrollContainer$VerticalScrollbar$VerticalIncreaseButton() {
        super();
