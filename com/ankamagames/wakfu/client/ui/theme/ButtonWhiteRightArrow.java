...
public class ButtonWhiteRightArrow implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonWhiteRightArrow() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "smallWhiteRightArrowDefault";
        ...
        final String id2 = "smallWhiteRightArrowOver";
        ...
        final String id3 = "smallWhiteRightArrowPressed";
        ...
        final String id4 = "smallWhiteRightArrowDisabled";
