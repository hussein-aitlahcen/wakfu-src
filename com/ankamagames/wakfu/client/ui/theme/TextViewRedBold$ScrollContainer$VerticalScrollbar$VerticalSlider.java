...
public class TextViewRedBold$ScrollContainer$VerticalScrollbar$VerticalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewRedBold$ScrollContainer$VerticalScrollbar$VerticalSlider() {
        super();
