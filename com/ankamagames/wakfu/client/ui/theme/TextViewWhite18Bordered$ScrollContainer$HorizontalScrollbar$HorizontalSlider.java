...
public class TextViewWhite18Bordered$ScrollContainer$HorizontalScrollbar$HorizontalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewWhite18Bordered$ScrollContainer$HorizontalScrollbar$HorizontalSlider() {
        super();
