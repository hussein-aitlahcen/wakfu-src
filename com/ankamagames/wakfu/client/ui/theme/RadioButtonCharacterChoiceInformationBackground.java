...
public class RadioButtonCharacterChoiceInformationBackground implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public RadioButtonCharacterChoiceInformationBackground() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        ((TextWidgetAppearance)appearance6).setAlignment(Alignment9.SOUTH);
        appearance6.setState("pressedSelected");
        widget.addBasicElement(appearance6);
        appearance6.onAttributesInitialized();
        final PixmapElement checkOut6 = PixmapElement.checkOut();
        checkOut6.setElementMap(elementMap);
        checkOut6.setHeight(176);
        checkOut6.setPosition(Alignment17.SOUTH);
        checkOut6.setTexture(this.doc.getTexture("preWorld_1.tga"));
        checkOut6.setWidth(160);
        checkOut6.setX(725);
        checkOut6.setY(45);
