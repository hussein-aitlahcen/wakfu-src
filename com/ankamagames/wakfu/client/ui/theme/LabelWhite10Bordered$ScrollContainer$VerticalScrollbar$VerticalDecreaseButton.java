...
public class LabelWhite10Bordered$ScrollContainer$VerticalScrollbar$VerticalDecreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public LabelWhite10Bordered$ScrollContainer$VerticalScrollbar$VerticalDecreaseButton() {
        super();
