...
public class ButtonReadyForFight implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonReadyForFight() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "pmReadyForFightDefault";
        final PixmapElement checkOut = PixmapElement.checkOut();
        checkOut.setElementMap(elementMap);
        if (elementMap != null && id != null) {
            elementMap.add(id, checkOut);
        }
        checkOut.setHeight(34);
        ...
        final String id2 = "pmReadyForFightOver";
        ...
        final String id3 = "pmReadyForFightPressed";
        ...
        final String id4 = "pmReadyForFightDisabled";
