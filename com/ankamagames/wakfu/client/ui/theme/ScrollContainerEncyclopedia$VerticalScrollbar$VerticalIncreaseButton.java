...
public class ScrollContainerEncyclopedia$VerticalScrollbar$VerticalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ScrollContainerEncyclopedia$VerticalScrollbar$VerticalIncreaseButton() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "pmSmallUpSideArrow2Default";
        ...
        final String id2 = "pmSmallUpSideArrow2Over";
        ...
        final String id3 = "pmSmallUpSideArrow2Pressed";
        ...
        final String id4 = "pmSmallUpSideArrow2Disabled";
        ...
        final String id5 = "pmSmallUpSideArrow2DefaultSelected";
        ...
        final String id6 = "pmSmallUpSideArrow2OverSelected";
        ...
        final String id7 = "pmSmallUpSideArrow2PressedSelected";
        ...
        final String id8 = "pmSmallUpSideArrow2DisabledSelected";
