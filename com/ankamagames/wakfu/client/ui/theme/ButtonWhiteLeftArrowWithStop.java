...
public class ButtonWhiteLeftArrowWithStop implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonWhiteLeftArrowWithStop() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "smallWhiteLeftArrowWithStopDefault";
        ...
        final String id2 = "smallWhiteLeftArrowWithStopOver";
        ...
        final String id3 = "smallWhiteLeftArrowWithStopPressed";
        ...
        final String id4 = "smallWhiteLeftArrowWithStopDisabled";
