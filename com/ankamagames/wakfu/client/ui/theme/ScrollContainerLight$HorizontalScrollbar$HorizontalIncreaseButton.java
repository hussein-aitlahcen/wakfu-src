...
public class ScrollContainerLight$HorizontalScrollbar$HorizontalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ScrollContainerLight$HorizontalScrollbar$HorizontalIncreaseButton() {
        super();
