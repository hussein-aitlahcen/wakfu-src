...
public class ButtonAchievementsGoBack implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonAchievementsGoBack() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "achievementsGoBackButtonDefaultPixmap";
        ...
        final String id2 = "achievementsGoBackButtonPressedPixmap";
        ...
        final String id3 = "achievementsGoBackButtonOverPixmap";
        ...
        final String id4 = "achievementsGoBackButtonDisabledPixmap";
