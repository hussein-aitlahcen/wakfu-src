...
public class TextViewWhite$ScrollContainer$VerticalScrollbar$VerticalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewWhite$ScrollContainer$VerticalScrollbar$VerticalSlider() {
        super();
