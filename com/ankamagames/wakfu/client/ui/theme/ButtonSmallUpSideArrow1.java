...
public class ButtonSmallUpSideArrow1 implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonSmallUpSideArrow1() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "pmSmallUpSideArrow1Default";
        ...
        final String id2 = "pmSmallUpSideArrow1Over";
        ...
        final String id3 = "pmSmallUpSideArrow1Pressed";
        ...
        final String id4 = "pmSmallUpSideArrow1Disabled";
        ...
        final String id5 = "pmSmallUpSideArrow1DefaultSelected";
        ...
        final String id6 = "pmSmallUpSideArrow1OverSelected";
        ...
        final String id7 = "pmSmallUpSideArrow1PressedSelected";
        ...
        final String id8 = "pmSmallUpSideArrow1DisabledSelected";
