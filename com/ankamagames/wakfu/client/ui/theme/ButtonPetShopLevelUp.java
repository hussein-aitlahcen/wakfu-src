...
public class ButtonPetShopLevelUp implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonPetShopLevelUp() {
        super();
