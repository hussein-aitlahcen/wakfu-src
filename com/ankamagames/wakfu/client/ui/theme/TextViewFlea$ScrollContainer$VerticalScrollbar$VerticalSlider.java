...
public class TextViewFlea$ScrollContainer$VerticalScrollbar$VerticalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewFlea$ScrollContainer$VerticalScrollbar$VerticalSlider() {
        super();
