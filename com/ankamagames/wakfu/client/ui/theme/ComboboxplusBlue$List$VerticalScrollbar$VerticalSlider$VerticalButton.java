...
public class ComboboxplusBlue$List$VerticalScrollbar$VerticalSlider$VerticalButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusBlue$List$VerticalScrollbar$VerticalSlider$VerticalButton() {
        super();
