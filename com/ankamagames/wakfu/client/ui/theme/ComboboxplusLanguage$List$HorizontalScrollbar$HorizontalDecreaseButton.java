...
public class ComboboxplusLanguage$List$HorizontalScrollbar$HorizontalDecreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusLanguage$List$HorizontalScrollbar$HorizontalDecreaseButton() {
        super();
