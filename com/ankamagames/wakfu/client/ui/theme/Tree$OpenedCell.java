...
public class Tree$OpenedCell implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public Tree$OpenedCell() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        appearance.setModulationColor(new Color(0.9f, 0.9f, 0.84f, 1.0f));
        widget.addBasicElement(appearance);
        appearance.onAttributesInitialized();
        final String id = "buttonFlatBackgroundPressed";
        ...
        final String id2 = "buttonFlatBorderPressed";
