...
public class ContainerWebShopCarrouselBorder implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerWebShopCarrouselBorder() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        checkOut4.setPosition(Alignment17.SOUTH_WEST);
