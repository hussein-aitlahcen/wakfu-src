...
public class TextViewCharacterCreation$ScrollContainer$VerticalScrollbar$VerticalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewCharacterCreation$ScrollContainer$VerticalScrollbar$VerticalIncreaseButton() {
        super();
