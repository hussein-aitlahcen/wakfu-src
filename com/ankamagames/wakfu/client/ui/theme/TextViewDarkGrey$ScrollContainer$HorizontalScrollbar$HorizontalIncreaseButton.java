...
public class TextViewDarkGrey$ScrollContainer$HorizontalScrollbar$HorizontalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewDarkGrey$ScrollContainer$HorizontalScrollbar$HorizontalIncreaseButton() {
        super();
