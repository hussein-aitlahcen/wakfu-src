...
public class TextViewWhite16Bordered$ScrollContainer$VerticalScrollbar$VerticalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewWhite16Bordered$ScrollContainer$VerticalScrollbar$VerticalIncreaseButton() {
        super();
