...
public class ComboboxplusBlue$List$HorizontalScrollbar$HorizontalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusBlue$List$HorizontalScrollbar$HorizontalSlider() {
        super();
