...
public class ContainerDimensionalBagRoomManagerCell implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerDimensionalBagRoomManagerCell() {
        super();
