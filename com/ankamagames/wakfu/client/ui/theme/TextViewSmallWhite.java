...
public class TextViewSmallWhite implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewSmallWhite() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        checkOut2.setRenderer(Xulor.getInstance().getDocumentParser().getFont("defaultSmallFont"));
