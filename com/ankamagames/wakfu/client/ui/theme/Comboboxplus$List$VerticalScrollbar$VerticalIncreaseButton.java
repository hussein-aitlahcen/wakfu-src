...
public class Comboboxplus$List$VerticalScrollbar$VerticalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public Comboboxplus$List$VerticalScrollbar$VerticalIncreaseButton() {
        super();
