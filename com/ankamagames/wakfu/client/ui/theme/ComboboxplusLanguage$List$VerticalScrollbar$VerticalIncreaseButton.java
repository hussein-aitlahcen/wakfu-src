...
public class ComboboxplusLanguage$List$VerticalScrollbar$VerticalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusLanguage$List$VerticalScrollbar$VerticalIncreaseButton() {
        super();
