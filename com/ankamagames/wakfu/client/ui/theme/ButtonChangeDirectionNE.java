...
public class ButtonChangeDirectionNE implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonChangeDirectionNE() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "pmChangeDirectionNEDefault";
        ...
        final String id2 = "pmChangeDirectionNEOver";
        ...
        final String id3 = "pmChangeDirectionNEPressed";
        ...
        final String id4 = "pmChangeDirectionNEDisabled";
