...
public class ComboboxplusChat$List$HorizontalScrollbar$HorizontalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusChat$List$HorizontalScrollbar$HorizontalIncreaseButton() {
        super();
