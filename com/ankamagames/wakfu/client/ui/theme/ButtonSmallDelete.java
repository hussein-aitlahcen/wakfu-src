...
public class ButtonSmallDelete implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonSmallDelete() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id2 = "smallDeleteButtonPressedPixmap";
        ...
        final String id3 = "smallDeleteButtonOverPixmap";
        ...
        final String id4 = "smallDeleteButtonDisabledPixmap";
