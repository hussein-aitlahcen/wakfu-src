...
public class ContainerItemSetSelectedBackground implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerItemSetSelectedBackground() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        appearance.setModulationColor(new Color(0.6f, 0.6f, 1.0f, 1.0f));
