...
public class LabelWhite10Bordered$ScrollContainer$VerticalScrollbar$VerticalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public LabelWhite10Bordered$ScrollContainer$VerticalScrollbar$VerticalIncreaseButton() {
        super();
