...
public class ContainerlogonFrame implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerlogonFrame() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "logonFrameContainerBorder";
        ...
        final String id2 = "logonFrameContainerBackground";
