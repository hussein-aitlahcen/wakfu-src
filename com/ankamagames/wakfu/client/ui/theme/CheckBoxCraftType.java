...
public class CheckBoxCraftType implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public CheckBoxCraftType() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        checkOut2.setHeight(67);
        checkOut2.setPosition(Alignment17.CENTER);
        checkOut2.setTexture(this.doc.getTexture("craft_0.tga"));
        checkOut2.setWidth(67);
        checkOut2.setX(142);
        checkOut2.setY(117);
        ...
        checkOut3.setHeight(67);
        checkOut3.setPosition(Alignment17.CENTER);
        checkOut3.setTexture(this.doc.getTexture("craft_0.tga"));
        checkOut3.setWidth(67);
        checkOut3.setX(72);
        checkOut3.setY(117);
        ...
        checkOut4.setHeight(67);
        checkOut4.setPosition(Alignment17.CENTER);
        checkOut4.setTexture(this.doc.getTexture("craft_0.tga"));
        checkOut4.setWidth(67);
        checkOut4.setX(142);
        checkOut4.setY(187);
        ...
        checkOut5.setHeight(67);
        checkOut5.setPosition(Alignment17.CENTER);
        checkOut5.setTexture(this.doc.getTexture("craft_0.tga"));
        checkOut5.setWidth(67);
        checkOut5.setX(72);
        checkOut5.setY(187);
        ...
        checkOut6.setHeight(67);
        checkOut6.setPosition(Alignment17.CENTER);
        checkOut6.setTexture(this.doc.getTexture("craft_0.tga"));
        checkOut6.setWidth(67);
        checkOut6.setX(72);
        checkOut6.setY(117);
        ...
        checkOut7.setHeight(67);
        checkOut7.setPosition(Alignment17.CENTER);
        checkOut7.setTexture(this.doc.getTexture("craft_0.tga"));
        checkOut7.setWidth(67);
        checkOut7.setX(142);
        checkOut7.setY(117);
        ...
        checkOut8.setHeight(67);
        checkOut8.setPosition(Alignment17.CENTER);
        checkOut8.setTexture(this.doc.getTexture("craft_0.tga"));
        checkOut8.setWidth(67);
        checkOut8.setX(2);
        checkOut8.setY(117);
