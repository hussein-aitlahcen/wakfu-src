...
public class CheckBoxChallengeChaos implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public CheckBoxChallengeChaos() {
        super();
