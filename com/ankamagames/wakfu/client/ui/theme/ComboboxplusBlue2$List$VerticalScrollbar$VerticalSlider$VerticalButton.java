...
public class ComboboxplusBlue2$List$VerticalScrollbar$VerticalSlider$VerticalButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusBlue2$List$VerticalScrollbar$VerticalSlider$VerticalButton() {
        super();
