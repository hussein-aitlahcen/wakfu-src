...
public class ComboboxplusLanguage$List$VerticalScrollbar$VerticalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusLanguage$List$VerticalScrollbar$VerticalSlider() {
        super();
