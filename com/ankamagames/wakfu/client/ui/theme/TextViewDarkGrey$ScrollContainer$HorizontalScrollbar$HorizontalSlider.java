...
public class TextViewDarkGrey$ScrollContainer$HorizontalScrollbar$HorizontalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewDarkGrey$ScrollContainer$HorizontalScrollbar$HorizontalSlider() {
        super();
