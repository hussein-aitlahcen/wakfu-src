...
public class TextViewRedBold$ScrollContainer$HorizontalScrollbar$HorizontalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewRedBold$ScrollContainer$HorizontalScrollbar$HorizontalIncreaseButton() {
        super();
