...
public class LabelDefaultMPTitle implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public LabelDefaultMPTitle() {
        super();
