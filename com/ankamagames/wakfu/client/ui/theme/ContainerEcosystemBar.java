...
public class ContainerEcosystemBar implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerEcosystemBar() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "ecosystemBarBorder";
        ...
        final String id2 = "ecosystemBarBackground";
