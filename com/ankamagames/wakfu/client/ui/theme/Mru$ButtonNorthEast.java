...
public class Mru$ButtonNorthEast implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public Mru$ButtonNorthEast() {
        super();
