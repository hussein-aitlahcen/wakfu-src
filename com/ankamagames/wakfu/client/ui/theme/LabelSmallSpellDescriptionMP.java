...
public class LabelSmallSpellDescriptionMP implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public LabelSmallSpellDescriptionMP() {
        super();
