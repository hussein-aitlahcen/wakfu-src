...
public class ButtonYellowSmallStyledLight implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonYellowSmallStyledLight() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id2 = "buttonYellowBackgroundFullOver";
        ...
        checkOut23.setColor(new Color(0.5f, 0.5f, 0.5f, 1.0f));
        ...
        final String id3 = "buttonYellowBackgroundFullPressed";
        ...
        checkOut34.setColor(new Color(0.5f, 0.5f, 0.5f, 1.0f));
        ...
        checkOut44.setFlipHorizontaly(true);
        checkOut44.setHeight(9);
        checkOut44.setPosition(Alignment17.SOUTH_EAST);
        checkOut44.setTexture(this.doc.getTexture("default_0.tga"));
        checkOut44.setWidth(9);
        checkOut44.setX(823);
        checkOut44.setY(93);
    ...
    public BasicElement method0(final BasicElement basicElement) {
        ...
        checkOut.setElementMap(elementMap);
        checkOut.setColor(new Color(0.8f, 0.8f, 0.8f, 1.0f));
