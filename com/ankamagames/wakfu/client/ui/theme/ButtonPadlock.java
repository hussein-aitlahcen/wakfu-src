...
public class ButtonPadlock implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonPadlock() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "padlockButtonDefaultPixmap";
        ...
        final String id2 = "padlockButtonPressedPixmap";
        ...
        final String id3 = "padlockButtonOverPixmap";
        ...
        final String id4 = "padlockButtonDisabledPixmap";
