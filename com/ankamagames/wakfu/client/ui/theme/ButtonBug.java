...
public class ButtonBug implements StyleSetter
{
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "bugButtonDefaultPixmap";
        ...
        final String id2 = "bugButtonPressedPixmap";
        ...
        final String id3 = "bugButtonOverPixmap";
        ...
        final String id4 = "bugButtonDisabledPixmap";
        final PixmapElement checkOut4 = PixmapElement.checkOut();
        checkOut4.setElementMap(elementMap);
        if (elementMap != null && id4 != null) {
            elementMap.add(id4, checkOut4);
        }
        checkOut4.setHeight(37);
