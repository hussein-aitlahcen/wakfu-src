...
public class AnimatedElementViewerLoginAnimRight implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public AnimatedElementViewerLoginAnimRight() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        ((AnimatedElementViewerAppearance)appearance).setAnimName("AnimLoginRight");
