...
public class TextViewWhite14 implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewWhite14() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        checkOut2.setRenderer(Xulor.getInstance().getDocumentParser().getFont("narrowFont14Bold"));
