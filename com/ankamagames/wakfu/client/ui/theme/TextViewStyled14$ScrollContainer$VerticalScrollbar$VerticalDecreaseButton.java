...
public class TextViewStyled14$ScrollContainer$VerticalScrollbar$VerticalDecreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewStyled14$ScrollContainer$VerticalScrollbar$VerticalDecreaseButton() {
        super();
