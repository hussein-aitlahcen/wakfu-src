...
public class TextViewSmallBold implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewSmallBold() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        checkOut.setRenderer(Xulor.getInstance().getDocumentParser().getFont("defaultBorderedFont"));
