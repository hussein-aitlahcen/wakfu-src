...
public class ScrollContainerLight$HorizontalScrollbar$HorizontalSlider$HorizontalButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ScrollContainerLight$HorizontalScrollbar$HorizontalSlider$HorizontalButton() {
        super();
