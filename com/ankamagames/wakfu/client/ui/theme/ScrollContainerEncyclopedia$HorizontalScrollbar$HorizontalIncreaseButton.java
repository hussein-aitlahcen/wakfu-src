...
public class ScrollContainerEncyclopedia$HorizontalScrollbar$HorizontalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ScrollContainerEncyclopedia$HorizontalScrollbar$HorizontalIncreaseButton() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "pmSmallRightSideArrow2Default";
        ...
        final String id2 = "pmSmallRightSideArrow2Over";
        ...
        final String id3 = "pmSmallRightSideArrow2Pressed";
        ...
        final String id4 = "pmSmallRightSideArrow2Disabled";
        ...
        final String id5 = "pmSmallRightSideArrow2DefaultSelected";
        ...
        final String id6 = "pmSmallRightSideArrow2OverSelected";
        ...
        final String id7 = "pmSmallRightSideArrow2PressedSelected";
        ...
        final String id8 = "pmSmallRightSideArrow2DisabledSelected";
