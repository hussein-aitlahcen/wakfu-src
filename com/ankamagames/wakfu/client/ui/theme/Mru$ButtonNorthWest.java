...
public class Mru$ButtonNorthWest implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public Mru$ButtonNorthWest() {
        super();
