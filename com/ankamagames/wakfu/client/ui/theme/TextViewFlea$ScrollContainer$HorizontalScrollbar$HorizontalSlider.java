...
public class TextViewFlea$ScrollContainer$HorizontalScrollbar$HorizontalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewFlea$ScrollContainer$HorizontalScrollbar$HorizontalSlider() {
        super();
