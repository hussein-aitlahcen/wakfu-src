...
public class TextviewTitleName implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextviewTitleName() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        checkOut.setRenderer(Xulor.getInstance().getDocumentParser().getFont("styleTitleNameFont"));
