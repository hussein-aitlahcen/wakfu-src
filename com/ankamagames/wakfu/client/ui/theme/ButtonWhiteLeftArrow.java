...
public class ButtonWhiteLeftArrow implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonWhiteLeftArrow() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "smallWhiteLeftArrowDefault";
        ...
        final String id2 = "smallWhiteLeftArrowOver";
        ...
        final String id3 = "smallWhiteLeftArrowPressed";
        ...
        final String id4 = "smallWhiteLeftArrowDisabled";
