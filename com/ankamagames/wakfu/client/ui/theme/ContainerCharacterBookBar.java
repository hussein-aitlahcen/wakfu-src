...
public class ContainerCharacterBookBar implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerCharacterBookBar() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "characterBookLabelBackground";
        ...
        final String id2 = "characterBookLabelBorder";
