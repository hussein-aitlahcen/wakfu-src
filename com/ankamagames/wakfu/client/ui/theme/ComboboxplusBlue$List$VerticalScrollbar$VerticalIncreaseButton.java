...
public class ComboboxplusBlue$List$VerticalScrollbar$VerticalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusBlue$List$VerticalScrollbar$VerticalIncreaseButton() {
        super();
