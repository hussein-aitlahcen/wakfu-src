...
public class ContainerScrollJauge implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerScrollJauge() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "scrollJaugeBackground";
        ...
        final String id2 = "scrollJaugeBorder";
