...
public class RadioButtonTab implements StyleSetter
{
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id5 = "tabOverBackground";
        ...
        final String id6 = "tabOverBorder";
        ...
        final String id8 = "tabPressedBackground";
        ...
        final String id9 = "tabPressedBorder";
        ...
        if (elementMap != null && id10 != null) {
            elementMap.add(id10, checkOut35);
        }
        checkOut35.setColor(new Color(0.29f, 0.17f, 0.07f, 1.0f));
        appearance4.addBasicElement(checkOut35);
        checkOut35.onAttributesInitialized();
        checkOut35.onChildrenAdded();
        final String id11 = "tabDisabledBackground";
        ...
        if (elementMap != null && id11 != null) {
            elementMap.add(id11, checkOut36);
        }
        ...
        final String id12 = "tabDisabledBorder";
    ...
    public BasicElement method4(final BasicElement basicElement) {
        ...
        checkOut.onAttributesInitialized();
        checkOut.onChildrenAdded();
        final String id2 = "tabDefaultSelectedBackground";
        ...
        checkOut3.onChildrenAdded();
        checkOut2.onChildrenAdded();
        final String id3 = "tabDefaultSelectedBorder";
        final PixmapBorder pixmapBorder = new PixmapBorder();
        pixmapBorder.onCheckOut();
        pixmapBorder.setElementMap(elementMap);
        if (elementMap != null && id3 != null) {
    ...
    public BasicElement method5(final BasicElement basicElement) {
        ...
        checkOut.onAttributesInitialized();
        checkOut.onChildrenAdded();
        final String id = "tabOverSelectedBackground";
        final PixmapBackground checkOut2 = PixmapBackground.checkOut();
        checkOut2.setElementMap(elementMap);
        if (elementMap != null && id != null) {
            elementMap.add(id, checkOut2);
        ...
        checkOut3.onChildrenAdded();
        checkOut2.onChildrenAdded();
        final String id2 = "tabOverSelectedBorder";
        final PixmapBorder pixmapBorder = new PixmapBorder();
        pixmapBorder.onCheckOut();
        pixmapBorder.setElementMap(elementMap);
        if (elementMap != null && id2 != null) {
