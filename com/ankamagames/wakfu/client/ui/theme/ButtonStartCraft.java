...
public class ButtonStartCraft implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonStartCraft() {
        super();
