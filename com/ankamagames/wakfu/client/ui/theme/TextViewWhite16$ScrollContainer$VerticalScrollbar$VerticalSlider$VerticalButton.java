...
public class TextViewWhite16$ScrollContainer$VerticalScrollbar$VerticalSlider$VerticalButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewWhite16$ScrollContainer$VerticalScrollbar$VerticalSlider$VerticalButton() {
        super();
