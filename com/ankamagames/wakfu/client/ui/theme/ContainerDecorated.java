...
public class ContainerDecorated implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerDecorated() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        element.setInsets(new Insets(12, 12, 25, 12));
        ...
        checkOut2.setTexture(this.doc.getTexture("death_0.tga"));
        ...
        checkOut3.setTexture(this.doc.getTexture("death_0.tga"));
        ...
        checkOut4.setTexture(this.doc.getTexture("death_0.tga"));
        checkOut4.setWidth(82);
        checkOut4.setX(2);
        checkOut4.setY(68);
        ...
        checkOut5.setTexture(this.doc.getTexture("death_0.tga"));
        checkOut5.setWidth(82);
        checkOut5.setX(2);
        checkOut5.setY(64);
        ...
        checkOut6.setTexture(this.doc.getTexture("death_0.tga"));
        checkOut6.setWidth(82);
        checkOut6.setX(2);
        checkOut6.setY(64);
        ...
        checkOut7.setTexture(this.doc.getTexture("death_0.tga"));
        checkOut7.setWidth(82);
        checkOut7.setX(2);
        checkOut7.setY(94);
        ...
        checkOut8.setTexture(this.doc.getTexture("death_0.tga"));
        ...
        checkOut9.setTexture(this.doc.getTexture("death_0.tga"));
        checkOut9.setWidth(82);
        checkOut9.setX(2);
        checkOut9.setY(94);
        ...
        checkOut10.setTexture(this.doc.getTexture("death_0.tga"));
