...
public class CheckBoxCharacteristicsDisplay implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public CheckBoxCharacteristicsDisplay() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        checkOut.setRotation(GeometrySprite.SpriteRotation.HALF);
        ...
        checkOut2.setRotation(GeometrySprite.SpriteRotation.HALF);
        ...
        checkOut3.setRotation(GeometrySprite.SpriteRotation.HALF);
        ...
        checkOut4.setRotation(GeometrySprite.SpriteRotation.HALF);
        checkOut4.setTexture(this.doc.getTexture("default_1.tga"));
        checkOut4.setWidth(35);
        checkOut4.setX(488);
        checkOut4.setY(514);
        ...
        checkOut5.setHeight(31);
        checkOut5.setPosition(Alignment17.CENTER);
        checkOut5.setRotation(GeometrySprite.SpriteRotation.HALF);
        checkOut5.setTexture(this.doc.getTexture("default_1.tga"));
        checkOut5.setWidth(35);
        checkOut5.setX(450);
        checkOut5.setY(514);
        ...
        checkOut6.setHeight(31);
        checkOut6.setPosition(Alignment17.CENTER);
        checkOut6.setRotation(GeometrySprite.SpriteRotation.HALF);
        checkOut6.setTexture(this.doc.getTexture("default_1.tga"));
        checkOut6.setWidth(35);
        checkOut6.setX(450);
        checkOut6.setY(514);
        ...
        checkOut7.setHeight(31);
        checkOut7.setPosition(Alignment17.CENTER);
        checkOut7.setRotation(GeometrySprite.SpriteRotation.HALF);
        checkOut7.setTexture(this.doc.getTexture("default_1.tga"));
        checkOut7.setWidth(35);
        checkOut7.setX(450);
        checkOut7.setY(514);
