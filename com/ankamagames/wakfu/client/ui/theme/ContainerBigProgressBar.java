...
public class ContainerBigProgressBar implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerBigProgressBar() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "progressBigContainerBorder";
        ...
        final String id2 = "progressBigContainerBackground";
