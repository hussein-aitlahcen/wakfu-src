...
public class ContainerLockSpellBackground implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerLockSpellBackground() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "lockSpellBorder";
        ...
        final String id2 = "lockSpellBackground";
        ...
        final String id3 = "ambianceZoneBarCenter";
