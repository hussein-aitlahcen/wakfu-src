...
public class ContainerTimelineTeamBlue implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ContainerTimelineTeamBlue() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        appearance.setModulationColor(new Color(0.56f, 0.95f, 0.91f, 1.0f));
