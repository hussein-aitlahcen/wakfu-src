...
public class ButtonFlatBig implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonFlatBig() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        checkOut23.setColor(new Color(0.32f, 0.39f, 0.42f, 1.0f));
        ...
        final String id9 = "mecanicBlueColor";
        ...
        checkOut34.setColor(new Color(0.32f, 0.39f, 0.42f, 1.0f));
        ...
        checkOut36.setPosition(Alignment17.CENTER);
