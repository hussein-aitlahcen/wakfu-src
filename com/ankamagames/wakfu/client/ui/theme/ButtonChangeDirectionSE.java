...
public class ButtonChangeDirectionSE implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonChangeDirectionSE() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "pmChangeDirectionSEDefault";
        ...
        final String id2 = "pmChangeDirectionSEOver";
        ...
        final String id3 = "pmChangeDirectionSEPressed";
        ...
        final String id4 = "pmChangeDirectionSEDisabled";
