...
public class ComboboxplusBlue2$List$HorizontalScrollbar$HorizontalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ComboboxplusBlue2$List$HorizontalScrollbar$HorizontalIncreaseButton() {
        super();
