...
public class TextViewWhite18$ScrollContainer$HorizontalScrollbar$HorizontalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewWhite18$ScrollContainer$HorizontalScrollbar$HorizontalIncreaseButton() {
        super();
