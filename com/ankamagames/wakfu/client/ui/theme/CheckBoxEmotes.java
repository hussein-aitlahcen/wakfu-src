...
public class CheckBoxEmotes implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public CheckBoxEmotes() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        final String id = "emotesButtonDefaultPixmap";
        ...
        final String id2 = "emotesButtonOverPixmap";
        ...
        final String id3 = "emotesButtonPressedPixmap";
        ...
        final String id4 = "emotesButtonSelectedPixmap";
        ...
        final String id5 = "emotesButtonSelectedOverPixmap";
        ...
        final String id6 = "emotesButtonSelectedPressedPixmap";
