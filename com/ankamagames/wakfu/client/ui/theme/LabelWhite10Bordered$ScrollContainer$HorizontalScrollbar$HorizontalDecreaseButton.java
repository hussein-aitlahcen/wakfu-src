...
public class LabelWhite10Bordered$ScrollContainer$HorizontalScrollbar$HorizontalDecreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public LabelWhite10Bordered$ScrollContainer$HorizontalScrollbar$HorizontalDecreaseButton() {
        super();
