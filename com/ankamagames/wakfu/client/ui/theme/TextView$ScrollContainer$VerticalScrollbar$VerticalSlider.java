...
public class TextView$ScrollContainer$VerticalScrollbar$VerticalSlider implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextView$ScrollContainer$VerticalScrollbar$VerticalSlider() {
        super();
