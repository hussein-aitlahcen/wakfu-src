...
public class TextViewWhite10Bordered$ScrollContainer$HorizontalScrollbar$HorizontalIncreaseButton implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewWhite10Bordered$ScrollContainer$HorizontalScrollbar$HorizontalIncreaseButton() {
        super();
