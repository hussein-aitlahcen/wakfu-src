...
public class TextViewDark16Bold implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public TextViewDark16Bold() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        checkOut2.setRenderer(Xulor.getInstance().getDocumentParser().getFont("narrowBoldFont16"));
