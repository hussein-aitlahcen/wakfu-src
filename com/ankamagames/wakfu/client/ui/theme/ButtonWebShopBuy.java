...
public class ButtonWebShopBuy implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public ButtonWebShopBuy() {
        super();
    ...
    public void applyStyle(final ElementMap item, final DocumentParser doc, final Widget widget) {
        ...
        checkOut.setTexture(this.doc.getTexture("webShop_0.tga"));
        checkOut.setWidth(36);
        checkOut.setX(183);
        checkOut.setY(93);
        ...
        checkOut2.setHeight(33);
        checkOut2.setPosition(Alignment17.CENTER);
        checkOut2.setTexture(this.doc.getTexture("webShop_0.tga"));
        ...
        checkOut3.setTexture(this.doc.getTexture("webShop_0.tga"));
        checkOut3.setWidth(36);
        checkOut3.setX(183);
        checkOut3.setY(57);
        ...
        checkOut4.setHeight(33);
        checkOut4.setPosition(Alignment17.CENTER);
        checkOut4.setTexture(this.doc.getTexture("webShop_0.tga"));
