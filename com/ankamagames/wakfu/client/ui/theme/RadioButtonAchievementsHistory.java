...
public class RadioButtonAchievementsHistory implements StyleSetter
{
    private DocumentParser doc;
    private Stack<ElementMap> elementMaps;
    
    public RadioButtonAchievementsHistory() {
        super();
