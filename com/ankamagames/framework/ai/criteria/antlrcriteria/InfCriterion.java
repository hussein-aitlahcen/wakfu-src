...
public class InfCriterion extends NumericalComparator
{
    private NumericalValue m_left;
    private NumericalValue m_right;
    
    private InfCriterion(final NumericalValue left, final NumericalValue right) {
        super();
        this.m_left = left;
        this.m_right = right;
    }
    ...
    public static SimpleCriterion generate(final ParserObject pleft, final ParserObject pright) {
        ...
        return new InfCriterion(left, right);
    }
    
    @Override
    public Enum getEnum() {
        return CriterionIds.INF;
    }
}
