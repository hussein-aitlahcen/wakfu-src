...
public class InfEqCriterion extends NumericalComparator
{
    private NumericalValue m_left;
    private NumericalValue m_right;
    
    private InfEqCriterion(final NumericalValue left, final NumericalValue right) {
        super();
        this.m_left = left;
        this.m_right = right;
    }
    ...
    public static SimpleCriterion generate(final ParserObject pleft, final ParserObject pright) {
        ...
        return new InfEqCriterion(left, right);
    }
    
    @Override
    public Enum getEnum() {
        return CriterionIds.INFEQ;
    }
}
