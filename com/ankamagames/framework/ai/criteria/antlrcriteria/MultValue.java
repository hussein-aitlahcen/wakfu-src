...
public class MultValue extends NumericalOperator
{
    private NumericalValue m_left;
    private NumericalValue m_right;
    
    private MultValue(final NumericalValue left, final NumericalValue right) {
        super();
        this.m_left = left;
        this.m_right = right;
    }
    ...
    public static NumericalValue generate(final ParserObject pleft, final ParserObject pright) {
        ...
        if (!left.isConstant() || !right.isConstant()) {
            return new MultValue(left, right);
        }
