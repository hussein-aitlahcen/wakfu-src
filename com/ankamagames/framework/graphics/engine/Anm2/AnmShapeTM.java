...
public class AnmShapeTM extends AnmShapeT
{
    byte m_mulRed;
    byte m_mulGreen;
    byte m_mulBlue;
    ...
    public void process(final AnmTransform parentTransform, final AnmTransform result) {
        ...
        result.m_red = parentTransform.m_red * (this.m_mulRed * 0.007874016f);
        result.m_green = parentTransform.m_green * (this.m_mulGreen * 0.007874016f);
        result.m_blue = parentTransform.m_blue * (this.m_mulBlue * 0.007874016f);
        result.m_alpha = parentTransform.m_alpha * (this.m_mulAlpha * 0.007874016f);
    }
}
