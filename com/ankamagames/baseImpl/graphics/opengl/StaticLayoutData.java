...
public class StaticLayoutData
{
    ...
    private boolean m_ensurePairDimension;
    
    public StaticLayoutData(final float widthPercentage, final float heightPercentage, final byte align) {
        super();
    ...
    public boolean isEnsurePairDimension() {
        return this.m_ensurePairDimension;
    }
    
    public void setEnsurePairDimension(final boolean ensurePairDimension) {
        this.m_ensurePairDimension = ensurePairDimension;
    }
}
